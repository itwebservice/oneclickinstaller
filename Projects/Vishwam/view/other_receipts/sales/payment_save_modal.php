      ...
      <div class="modal-body">
            ...
            <legend>Receipt Details</legend>
              ...
              <div class="row mg_bt_20">                      
                ...
                <div class="col-md-4">
                  <input type="text" id="payment_amount" name="payment_amount" class="form-control" placeholder="*Amount" title="Amount" onchange="validate_balance(this.id);payment_amount_validate(this.id,'payment_mode','transaction_id','bank_name');">
                </div>             
                <div class="col-md-4">
