      ...
      <div class="modal-body">
        ...
        <form id="frm_train_ticket_payment_update">
         ...
         <div class="row mg_bt_10">
          ...
          <div class="col-md-3">
            <input type="text" id="payment_amount1" name="payment_amount1" class="form-control" placeholder="Amount" title="Amount" value="<?= $sq_payment_info['payment_amount'] ?>" onchange="number_validate(this.id);">
          </div>          
        </div>
        <div class="row mg_bt_10">
          <div class="col-md-3">
  ...
  submitHandler:function(form){
    ...
    $('#train_p_update').button('loading');
      ...
      $.ajax({
        ...
        data:{ payment_id : payment_id, train_ticket_id : train_ticket_id, payment_date : payment_date, payment_amount : payment_amount, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id, payment_old_value : payment_old_value },
