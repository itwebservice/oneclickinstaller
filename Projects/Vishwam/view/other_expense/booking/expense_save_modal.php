    ...
    <div class="modal-content">
      	...
      	<input type="hidden" id="emp_id" name="emp_id" value="<?= $emp_id ?>" >
			...
			<legend>*Expense For</legend>				
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
						<select name="supplier_type" id="supplier_type" title="Supplier Type" class="form-control" style="width:100%">
      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <select name="taxation_id" id="taxation_id" title="Tax" onchange="generic_tax_reflect(this.id, 'service_tax', 'total_fun');">  
          ...
          if(data !== 'valid'){
            ...
            if(data !== 'valid'){
              ...
              $.ajax({
                ...
                data:{ expense_type : expense_type, supplier_type : supplier_type, sub_total : sub_total, taxation_type : taxation_type, service_tax : service_tax,taxation_id : taxation_id, service_tax_subtotal : service_tax_subtotal, tds : tds, net_total : net_total, due_date : due_date, booking_date : booking_date, invoice_no : invoice_no, id_upload_url : id_upload_url, payment_date : payment_date, payment_amount : payment_amount, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id,branch_admin_id : branch_admin_id, payment_evidence_url : payment_evidence_url, emp_id : emp_id},
