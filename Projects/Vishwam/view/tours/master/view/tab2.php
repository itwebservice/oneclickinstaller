		        ...
		        <table class="table no-marg table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo date('d-m-Y H:i:s', strtotime($sq_tourgrp2['departure_date'])); ?></td>
							<td><?php echo date('d-m-Y H:i:s', strtotime($sq_tourgrp2['arrival_date'])); ?></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
		        ...
		        <table class="table no-marg table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo date('d/m/Y H:i:s', strtotime($sq_tourgrp['dapart_time'])); ?></td>
							<td><?php echo date('d/m/Y H:i:s', strtotime($sq_tourgrp['arraval_time'])); ?></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
             ...
             <div class="table-responsive">
		        <table class="table no-marg table-bordered">
					...
					<tbody>
						...
						<tr>
							<td><?php echo $count++; ?></td>
							<td><?php echo get_datetime_user($sq_tourgrp_c['dept_datetime']); ?></td>
							<td><?php echo get_datetime_user($sq_tourgrp_c['arrival_datetime']); ?></td>
