        ...
        <div class="panel panel-default panel-body app_panel_style">
            <div class="row text-center">   
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs"> 
                    ...
                    <input type="text" id="txt_children_cost" name="txt_children_cost" onchange="validate_balance(this.id)" class="form-control"  placeholder="*Children  Cost" title="Children  Cost" maxlength="10" />
