	...
	<div class="col-sm-6 col-xs-12 col-sm-offset-3">
		<div class="widget_parent-bg-img bg-img-red">
			<?php begin_widget();
                ...
                $content_arr = array($booking_amt , $sq_booking_info['service_tax_subtotal'], $sq_booking_info['total_fees']);
		...
		<form id="frm_refund" class="no-marg">
			<div class="row text-center">
				<div class="col-sm-6 col-xs-12 mg_bt_20">
					<input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_booking_info['cancel_amount'] ?>">
				</div>
				<div class="col-sm-6 col-xs-12 mg_bt_20">
