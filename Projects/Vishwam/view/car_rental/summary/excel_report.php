...
$row_count =11;
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('M'.$row_count, "Other_Charges")  
                ...
                ->setCellValue('S'.$row_count, "Due_Date")
                ->setCellValue('T'.$row_count, "Purchase")
                ->setCellValue('U'.$row_count, "Purchased_From")
                ->setCellValue('V'.$row_count, "Branch")
                ->setCellValue('W'.$row_count, "Booked_By")
                ->setCellValue('X'.$row_count, "Enquiry_no")           
                ->setCellValue('Y'.$row_count, "Enquiry_Date");
    	...
    	$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D'.$row_count, $customer_name)
            ->setCellValue('E'.$row_count,($sq_customer_info['contact_no']))
            ->setCellValue('F'.$row_count,($sq_customer_info['email_id']))
            ...
            ->setCellValue('K'.$row_count, number_format($row_car['actual_cost']+$row_car['km_total_fee'],2))
            ->setCellValue('L'.$row_count, number_format($row_car['service_tax_subtotal'],2))
            ->setCellValue('M'.$row_count, number_format($other_charges,2))
            ->setCellValue('N'.$row_count, number_format($total_sale,2))
            ->setCellValue('O'.$row_count, number_format($cancel_amount, 2))
            ->setCellValue('P'.$row_count, number_format($total_bal, 2))
            ...
            ->setCellValue('X'.$row_count, get_enquiry_id($row_car['enquiry_id']))
            ->setCellValue('Y'.$row_count, get_date_user($row_car['enquiry_date']));
