...
$query .= " order by booking_id desc";
 ...
 $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('L'.$row_count, "Discount")
                ->setCellValue('M'.$row_count, "TDS")
...
$count = 0;
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D'.$row_count, $customer_name)
            ->setCellValue('E'.$row_count,($sq_customer['contact_no']))
            ->setCellValue('F'.$row_count,($sq_customer['email_id']))
            ...
            ->setCellValue('J'.$row_count, number_format($row_booking['service_charge'],2))
            ->setCellValue('K'.$row_count, number_format($row_booking['service_tax_subtotal'],2))
            ->setCellValue('L'.$row_count, number_format($row_booking['discount'],2))
            ->setCellValue('M'.$row_count, number_format($row_booking['tds'],2))
            ->setCellValue('N'.$row_count, number_format($row_booking['total_fee'],2))
            ->setCellValue('O'.$row_count, number_format($can_amount,2))
            ->setCellValue('P'.$row_count, number_format($total_bal,2))
            ->setCellValue('Q'.$row_count, number_format($paid_amount,2))
            ->setCellValue('R'.$row_count, number_format($bal_amount,2))
            ->setCellValue('S'.$row_count, $due_date)
