...
if($sq_tr_refund == ''){
	...
	$total_sale = $actual_travel_expense + $actual_tour_expense - $incentive_amount;
	$tax_amount = $tourwise_details['train_service_tax_subtotal'] + $tourwise_details['plane_service_tax_subtotal'] + $tourwise_details['cruise_service_tax_subtotal'] + $tourwise_details['visa_service_tax_subtotal'] + $tourwise_details['insuarance_service_tax_subtotal'] + $tourwise_details['tour_service_tax_subtotal'];
	$total_sale -= $tax_amount;
}
