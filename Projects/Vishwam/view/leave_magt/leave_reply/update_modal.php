  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
          <div class="row mg_bt_10">
                ...
                <div class="col-sm-8 col-xs-12">
	              <input type="text" id="emp_id" name="emp_id" placeholder="*Employee Id" title="Employee Id" value="<?= $sq_req['emp_id'] ?>" disabled>
	            </div>
	       	</div>
          <div class="row mg_bt_10 hidden">
              <div class="col-md-3 text-right"><label for="emp_id">ID</label></div>
	       	...
	       	<div class="row mg_bt_10">
	            <div class="col-md-3 text-right"><label for="emp_name">Name</label></div>
	            <div class="col-sm-8 col-xs-12">
        	...
        	<div class="row mg_bt_10">
	        	<div class="col-md-3 text-right"><label for="emp_branch">Branch</label></div>
		        	<div class="col-sm-8 col-xs-12">
		              <input type="text" id="emp_branch" name="emp_branch" placeholder="*Branch" title="Branch" value="<?= $sq_branch['branch_name'] ?>" disabled>
		            </div> 
		    </div> 
		    <div class="row mg_bt_10">
	        	<div class="col-md-3 text-right"><label for="designation">Designation</label></div>      
		            <div class="col-sm-8 col-xs-12">
        ...
        <div class="row mg_bt_10">
            <div class="col-md-3 text-right"><label for="reason_for_leave">Reason for leave</label></div>    
                <div class="col-sm-8 col-xs-12">
		    ...
		    <div class="row mg_bt_10">
        		<div class="col-md-3 text-right"><label for="type_of_leave">Type Of Leave</label></div> 
		            <div class="col-md-8">
		    ...
		    <div class="row mg_bt_10">
	        	<div class="col-md-3 text-right"><label for="from_date">From Date</label></div>                 
		             <div class="col-sm-8 col-xs-12">
		    ...
		    <div class="row mg_bt_10">
	        	<div class="col-md-3 text-right"><label for="to_date">To Date</label></div> 
	             	<div class="col-sm-8 col-xs-12">
		    ...
		    <div class="row mg_bt_10">
	        	<div class="col-md-3 text-right"><label for="no_of_days">No of days</label></div>     
		            <div class="col-sm-8 col-xs-12">
		              <input type="text" id="no_of_days" name="no_of_days"  placeholder="No of days" title="No of days" value="<?= $sq_req['no_of_days'] ?>" disabled>
		            </div>
		    </div>
	    	<div class="row mg_bt_10">
        		<div class="col-md-3 text-right"><label for="comments">Comments</label></div>    
	            	<div class="col-sm-8 col-xs-12">
