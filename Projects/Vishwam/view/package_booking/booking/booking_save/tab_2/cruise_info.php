<div class="row mg_bt_10" >
    <div class="col-md-4 col-sm-6">
        <input type="checkbox" id="chk_cruise_select_all" onchange="select_all('tbl_dynamic_cruise_package_booking',this.id);  calculate_cruise_expense('tbl_dynamic_cruise_package_booking')" checked>&nbsp;&nbsp;<label for="chk_cruise_select_all">Select All</label>
    </div>
    <div class="col-md-8 col-sm-6 text-right">
        ...
        <button type="button" class="btn btn-pdf btn-sm" onClick="deleteRow('tbl_dynamic_cruise_package_booking'); calculate_cruise_expense('tbl_dynamic_cruise_package_booking')" title="Delete Row"><i class="fa fa-trash"></i></button>
...
<div class="row"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    <table id="tbl_dynamic_cruise_package_booking" name="tbl_dynamic_cruise_package_booking" class="table table-bordered mg_bt_30">
        <tr>
            ...
            <td><input type="text" id="cruise_departure_date" onchange="get_to_datetime(this.id, 'cruise_arrival_date')" name="cruise_departure_date" placeholder="Departure Date & Time" title="Departure Date & Time" class="app_datetimepicker" value="<?= date('d-m-Y H:i:s') ?>"></td>
            ...
            <td style="width: 130px;"><input type="text" id="txt_cruise_amount1" name="txt_cruise_amount1" placeholder="*Amount" title="Amount" onchange="validate_balance(this.id);" onkeyup=" calculate_cruise_expense('tbl_dynamic_cruise_package_booking');" /></td>
        </tr>
    </table>
