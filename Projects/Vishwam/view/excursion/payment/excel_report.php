...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('D'.$row_count, "Concern Person")
...
while($row_exc_payment = mysql_fetch_assoc($sq_exc_payment)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('G'.$row_count, number_format($row_exc_payment['payment_amount'],2));
	...
	$objPHPExcel->getActiveSheet()->getStyle('B'.$row_count.':G'.$row_count)->applyFromArray($borderArray);    
        ...
        ->setCellValue('F'.$row_count, 'Cancel Amount : '.number_format($sq_cancel_amount,2))
