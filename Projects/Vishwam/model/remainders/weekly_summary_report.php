...
include_once('../model.php');
    ...
    if($day=='Sat'){        
                    ...
                    <table style="width:100%">
                        <tr>
                            <td style="padding: 0; width: 100%; text-align: center; margin-bottom: 20px !important;
                                  display: block;">
                                <a style="background: #009898;color: #fff; border:aliceblue;width:auto;text-decoration: none;  display: block;text-transform: uppercase;padding: 0 10px;font-weight: 600;" href="'.BASE_URL.'model/remainders/weekly_summary_html.php">Click here to view Weekly summary report</a> 
                            </td>
                        </tr>
                    <table> 
                </td>
        ...
        ';
            ...
            $model->app_email_send('93',$app_email_id, $email_content,$subject);
