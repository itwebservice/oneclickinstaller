...
function foo (tableID, quot_table_id) {
	...
	if (tableID == 'tbl_package_hotel_master' || tableID == 'tbl_package_hotel_master_dynamic_update') { // new edits
		var prefix = tableID == 'tbl_package_tour_quotation_dynamic_plane_update' ? '_d' : '';
	...
	if (
		...
		row.cells[4].childNodes[0].setAttribute('id', 'room_cat1' + prefix + foo.counter);
		row.cells[5].childNodes[0].setAttribute('id', 'hotel_type1' + prefix + foo.counter);
		row.cells[6].childNodes[0].setAttribute('id', 'hotel_stay_days1' + prefix + foo.counter);
		row.cells[7].childNodes[0].setAttribute('id', 'no_of_rooms1' + prefix + foo.counter);
		row.cells[8].childNodes[0].setAttribute('id', 'extra_bedb1' + prefix + foo.counter);
		row.cells[9].childNodes[0].setAttribute('id', 'package_name' + prefix + foo.counter);
		row.cells[10].childNodes[0].setAttribute('id', 'hotel_cost' + prefix + foo.counter);
		row.cells[11].childNodes[0].setAttribute('id', 'package_id' + prefix + foo.counter);
		row.cells[12].childNodes[0].setAttribute('id', 'extra_bed_cost' + prefix + foo.counter);
	...
	if(tableID == 'tbl_group_tour_quotation_dynamic_plane' || tableID == 'tbl_group_tour_quotation_dynamic_plane_update'){
	...
	if (tableID == 'tbl_dynamic_visa' || tableID == 'tbl_dynamic_visa_update') {
		...
		row.cells[16].childNodes[0].setAttribute('id', 'visa_service_cost' + prefix + foo.counter);
	...
	if (tableID == 'table_exc_time_slot') {
		...
		$('#'+row.cells[2].childNodes[0].id).datetimepicker({ datepicker:false, format:'H:i A',showMeridian: true });
		$('#'+row.cells[3].childNodes[0].id).datetimepicker({ datepicker:false, format:'H:i A',showMeridian: true });
