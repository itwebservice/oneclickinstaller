<div class="row mg_bt_10">
    <div class="col-md-12 text-right text_center_xs">
        <button type="button" class="btn btn-excel btn-sm" onClick="addRow('tbl_package_hotel_master_dynamic_update')"><i class="fa fa-plus"></i></button>
    </div>
</div>
			...
			if($sq_plane_count==0){
				...
				while($row_q_hotel = mysql_fetch_assoc($sq_q_hotel)){
                    ...
                    <tr>
                        ...
                        <td><select id="city_name<?= $offset.$count?>_d" name="city_name1<?= $offset.$count?>_d" onchange="hotel_name_list_load(this.id);" class="city_master_dropdown app_select2" style="width:100%" title="Select City Name">
