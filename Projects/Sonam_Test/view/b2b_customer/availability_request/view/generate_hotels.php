...
<div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
    ...
    <div class="row text-right mg_bt_10">
        <div class="col-xs-12">
            <button type="button" class="btn btn-excel btn-sm" onclick="addRow('tbl_similar_hotels<?=$count?>',<?=$count?>)" title="Add row"><i class="fa fa-plus"></i></button>
...
<script>
$('#city_id1<?=$count?>').select2({minimumInputLength:1});
