                ...
                <div class="panel panel-default panel-body main_block bg_light mg_bt_30">
                    ...
                    <div class="bg_white main_block panel-default-inner">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            ...
                            <input type="text" id="txt_child_bed_expense" title="Child With Bed" placeholder="Child With Bed" name="txt_child_bed_expense" class="text-right form-control valid" onchange="tour_cost_calculate();validate_balance(this.id)"  />           
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            <label>Child Without Bed</label>
                            <input type="text" id="txt_child_wbed_expense" title="Children Without Bed" placeholder="Children Without Bed" name="txt_child_wbed_expense" class="text-right form-control valid" onchange="tour_cost_calculate();validate_balance(this.id)"  />           
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            <label>Infant</label>
