...
<table id="tbl_activities" name="tbl_activities" class="table border_0 table-hover no-marg">
    ...
    if(sizeof($col2)==0){?>
        <tr>
            ...
            <td><select name="city_name-1" id="city_name-11" title="Select City" onchange="excursion_dynamic_reflect(this.id)" style="width:100%" class="form-control app_select2">
