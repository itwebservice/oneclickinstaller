...
function whatsapp_send_b(quotation_id, tour_name, tour_from_date, customer_id,  emp_id ){
	$.post($('#base_url').val()+"controller/package_tour/booking/whatsapp_send.php",{quotation_id:quotation_id,tour_name:tour_name, tour_from_date:tour_from_date, customer_id:customer_id, emp_id : emp_id }, function(data){
		window.open(data);
	});
}
