...
<form id="frm_tab1_u">
	...
	<div class="row">
	    ...
	    <!-- <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	    	...
	    	<input type="text" id="total_children1" name="total_children1" placeholder="Total Children" title="Total Children" onchange="total_passangers_calculate('1');cost_reflect(); validate_balance(this.id)" value=" $sq_quotation['total_children'] ?>">

	    </div> -->
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">

	     <input type="text" class="form-control" id="children_with_bed2" name="children_with_bed2" title="Children With Bed" onchange="validate_balance(this.id);cost_reflect()" placeholder="Children With Bed" title="Children With Bed" value="<?= $sq_quotation['children_with_bed'] ?>">   

	    </div>
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">

	      <input type="text" class="form-control" id="children_without_bed1" name="children_without_bed1" title="Children Without Bed" onchange="validate_balance(this.id)" placeholder="Children Without Bed" title="Children Without Bed" value="<?= $sq_quotation['children_without_bed'] ?>">
