...
<div class="row mg_bt_10">
	...
	<div class="col-md-2">
		...
		<input type="text" id="with_bed_cost" name="with_bed_cost" placeholder="Child With Bed Cost" title="Child With Bed Cost" value="0" onchange="group_quotation_cost_calculate();validate_balance(this.id);"> 

	</div>
  	<div class="col-md-2">

  		<input type="text" id="children_cost" name="children_cost" placeholder="Child Without Bed Cost" title="Child Without Bed Cost" value="0" onchange="group_quotation_cost_calculate(); validate_balance(this.id);"> 
