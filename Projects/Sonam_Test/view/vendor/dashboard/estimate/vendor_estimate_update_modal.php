      ...
      <div class="modal-body">
			...
			<legend>Supplier Purchase</legend>
				...
				<div class="row">					
					...
					<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
						<input type="text" id="service_charge" name="service_charge" placeholder="Service Charge" title="Service Charge" onchange="validate_balance(this.id);calculate_estimate_amount('')" value="<?= $sq_vendor_estimate['service_charge'] ?>">
					</div>
					<div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
