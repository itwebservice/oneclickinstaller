 <tr>
    <td><input class="css-checkbox" id="chk_passport<?= $offset ?>1" type="checkbox" checked><label class="css-label" for="chk_passport<?= $offset ?>1"> <label></td>
    ...
    <td style="width:80px"><input type="text" id="adolescence<?= $offset ?>1" name="adolescence<?= $offset ?>1" placeholder="Adolescence" title="Adolescence" disabled/></td>
