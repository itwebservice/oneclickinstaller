...
//////////////////**Booking successfull sms send to traveler start**//////////
 ...
 function booking_successfull_sms_send($mobile_no,$tour_name,$customer_id){
    ...
    $message = "Dear ".$fname." ".$lname.", your booking for ".$tour_name." has been confirmed. Voucher details sent on your Mail ID within 3 working days prior to the tour.";
...
Thank you.');
	$link = 'https://web.whatsapp.com/send?phone='.$mobile_no['landline_no'].'&text='.$whatsapp_msg;
	echo $link;
}
