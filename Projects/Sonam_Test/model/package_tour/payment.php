...
//////////////////////////////////**Payment sms notification send start**/////////////////////////////////////
 public function payment_sms_notification_send($booking_id, $payment_amount, $payment_mode,$customer_id){
    ...
    $message = "Dear ". $fname." ". $lname.", Acknowledge your payment of ".$payment_amount." ".$currency_code." , ".$payment_mode." which we received for Package Tour installment. (T&C) Check the currency from the Company Profile Section.";
