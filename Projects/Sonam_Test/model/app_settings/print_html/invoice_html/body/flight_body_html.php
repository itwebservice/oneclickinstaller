  ...
  <div class="row">
    <div class="col-md-12">
      <div class="main_block inv_rece_calculation border_block">
        <div class="col-md-6"><p class="border_lt"><span class="font_5">AMOUNT </span><span class="float_r"><?php echo $currency_logo." ".number_format($basic_cost1,2); ?></span></p></div>
        <div class="col-md-6"><p class="border_lt"><span class="font_5">TOTAL </span><span class="font_5 float_r"><?php echo $currency_logo." ".number_format($net_amount1,2); ?></span></p></div>
        <div class="col-md-6"><p class="border_lt"><span class="font_5">SERVICE CHARGE </span><span class="float_r"><?php echo $currency_logo." ".number_format($sq_fields['service_charge'],2); ?></span></p></div>
        <div class="col-md-6"><p class="border_lt"><span class="font_5">ADVANCED PAID </span><span class="font_5 float_r"><?php echo $currency_logo." ".number_format($total_paid,2); ?></span></p></div>
        ...
        <div class="col-md-6"><p class="border_lt"><span class="font_5">CURRENT DUE </span><span class="font_5 float_r"><?php echo $currency_logo." ".number_format($balance_amount,2); ?></span></p></div>
        </div>
        <div class="row no-marg">
        ...
        <div class="col-md-6"><p class="border_lt"><span class="font_5">CURRENT DUE </span><span class="font_5 float_r"><?php echo $currency_logo." ".number_format($balance_amount,2); ?></span></p></div> <?php } ?>
        <div class="row no-marg">
          <div class="col-md-6"><p class="border_lt"><span class="font_5">OTHER TAX </span><span class="float_r"><?php echo $currency_logo." ".number_format($other_tax,2); ?></span></p></div>
        </div>
        <div class="col-md-6"><p class="border_lt"><span class="font_5">TDS </span><span class="float_r"><?php echo $currency_logo." ".number_format($sq_fields['tds'],2); ?></span></p></div>
      </div>
    </div>
  </div>
</section>
