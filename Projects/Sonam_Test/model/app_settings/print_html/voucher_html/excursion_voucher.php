...
$sq_excname = mysql_fetch_assoc(mysql_query("select * from excursion_master_entries where exc_id='$booking_id'"));
    ...
    <section class="print_sec main_block">
      ...
      <div class="row">
        ...
        <div class="col-md-5 mg_bt_20">
          <ul class="print_info_list no-pad noType">
            <li><span>TOTAL GUEST(s) :</span> <?= $sq_excname['total_adult']+$sq_excname['total_child'] ?></li>
          </ul>
        </div>
      </div>
    </section>
         ...
         <div class="table-responsive">
          <table class="table table-bordered no-marg" id="tbl_emp_list">
            ...
            while($row_exc_acc=mysql_fetch_assoc($sq_exc_acc)){
              ...
              $sq_exc_name = mysql_fetch_assoc(mysql_query("select * from itinerary_paid_services where service_id='$row_exc_acc[exc_name]'"));
            ?>
                <tr>
