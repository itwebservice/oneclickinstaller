...
?>
  ...
  <?php //Hotel
  $sq_supp = mysql_query("select hotel_id,hotel_name from hotel_master");
  while($row_supp= mysql_fetch_assoc($sq_supp)){ ?>
    <option value="<?= $row_supp['hotel_name'] ?>"><?=  $row_supp['hotel_name'] ?></option>
  <?php } ?>
  </optgroup>
  <optgroup value='transport' label="Transport">
  <?php  //Transport
    $sq_supp = mysql_query("select transport_agency_id,transport_agency_name from transport_agency_master");
    while($row_supp= mysql_fetch_assoc($sq_supp)){ ?>
      <option value="<?= $row_supp['transport_agency_name'] ?>"><?=  $row_supp['transport_agency_name'] ?></option>
  <?php } ?>
  </optgroup>
  <optgroup value='dmc' label="DMC">
  <?php  //DMC
    $sq_supp = mysql_query("select dmc_id,company_name from dmc_master");
    while($row_supp= mysql_fetch_assoc($sq_supp)){ ?>
      <option value="<?= $row_supp['company_name'] ?>"><?=  $row_supp['company_name'] ?></option>
  <?php } ?>
  </optgroup>
  <optgroup value='car' label="Car Rental">
  <?php  //Car Rental
    $sq_supp = mysql_query("select vendor_id,vendor_name from car_rental_vendor");
    while($row_supp= mysql_fetch_assoc($sq_supp)){ ?>
  ...
  <?php  //Visa
    $sq_supp = mysql_query("select vendor_id,vendor_name from visa_vendor");
    while($row_supp= mysql_fetch_assoc($sq_supp)){ ?>
      <option value="<?= $row_supp['vendor_name'] ?>"><?=  $row_supp['vendor_name'] ?></option>
  <?php } ?>
  </optgroup>
  ...
  <?php  //Acticity
    $sq_supp = mysql_query("select vendor_id,vendor_name from site_seeing_vendor");
    while($row_supp= mysql_fetch_assoc($sq_supp)){ ?>
      <option value="<?= $row_supp['vendor_name'] ?>"><?=  $row_supp['vendor_name'] ?></option>
  <?php } ?>
  </optgroup>
  ...
  <?php  //Cruise
    $sq_supp = mysql_query("select cruise_id,company_name from cruise_master");
    while($row_supp= mysql_fetch_assoc($sq_supp)){ ?>
      <option value="<?= $row_supp['company_name'] ?>"><?=  $row_supp['company_name'] ?></option>
  <?php } ?>
  </optgroup>
  ...
  <?php  //Other
    $sq_supp = mysql_query("select vendor_id,vendor_name from other_vendors");
    while($row_supp= mysql_fetch_assoc($sq_supp)){ ?>
      <option value="<?= $row_supp['vendor_name'] ?>"><?=  $row_supp['vendor_name'] ?></option>
  <?php } ?>
  </optgroup>
