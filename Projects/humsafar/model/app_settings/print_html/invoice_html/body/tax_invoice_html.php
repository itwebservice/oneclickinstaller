...
<section class="no-pad main_block gst_invoice side_pad_10">  
        ...
        <table class="table no-marg mg_tp_5 gst_invoice" style="padding: 0 !important;">
         ...
         ?>  
            <tr>
              ...
              <td class="text-right"></td>
              <td class="text-right"><?= $basic_cost1 ?></td>
              <td class="text-right"></td>
              <td class="text-right"><?=  number_format($service_charge,2); ?></td>
              <td class="text-right"></td>
              <td class="text-right"><?php if($taxation_type=="SGST CGST"){echo $cgst_sgst; } ?></td>
              <td class="text-right"></td>
              <td class="text-right"><?php if($taxation_type=="SGST CGST"){echo $cgst_sgst; } ?></td>
              <td class="text-right"></td>
              <td class="text-right"><?php if($taxation_type=="IGST"){echo $service_tax_subtotal; } ?></td>
              <td class="text-right"></td>
              <td class="text-right"><?php if($taxation_type=="UGST"){echo $service_tax_subtotal; } ?></td>
  ...
  <div class="main_block inv_rece_table">
    <div class="row">
      ...
      <div class="col-md-4">
      <?php
         $total_amount_before_tax = $basic_cost1+$service_charge;          
      ?>
       <div class="row">
         <div class="col-md-12">
           <div class="table-responsive">
            <table class="table no-marg mg_tp_5 gst_invoice" style="padding: 0 !important;">
              <tr>
                ...
                <td class="text-right col-md-4"><?= number_format($total_amount_before_tax,2) ?></td>
              </tr>
              <tr>
                <td class="text-right col-md-8">Add : CGST <?php if($taxation_type=="SGST CGST"){ ?>@<?= $service_tax_per/2 ?>%<?php } ?> :</td>
                <td class="text-right col-md-4"><?php if($taxation_type=="SGST CGST"){echo $cgst_sgst; } ?></td>
              </tr>
              <tr>
                <td class="text-right col-md-8">Add : SGST <?php if($taxation_type=="SGST CGST"){ ?>@<?= $service_tax_per/2 ?>%<?php } ?> :</td>
                <td class="text-right col-md-4"><?php if($taxation_type=="SGST CGST"){echo $cgst_sgst; } ?></td>
              </tr>
              <tr>
                <td class="text-right col-md-8">Add : IGST <?php if($taxation_type=="IGST"){ ?>@<?= $service_tax_per ?>%<?php } ?> :</td>
                <td class="text-right col-md-4"> <?php if($taxation_type=="IGST"){echo $service_tax_subtotal; } ?></td>
              </tr>
              <tr>
                <td class="text-right col-md-8">Add : UGST <?php if($taxation_type=="UGST"){ ?>@<?= $service_tax_per ?>%            <?php } ?>:</td>
                <td class="text-right col-md-4"> <?php if($taxation_type=="UGST"){echo $service_tax_subtotal; } ?></td>
              </tr>
              <tr>
                <td class="text-right col-md-8">Tax Amount : GST @<?= $service_tax_per ?>% :</td>
                <td class="text-right col-md-4"><?= $service_tax_subtotal ?></td>
              </tr>
              <tr class="hightlited_row">
                <td class="text-right col-md-8">Total Amount After Tax :</td>
                <td class="text-right col-md-4"><?= number_format($net_amount,2) ?></td>
              </tr>
            </table>
           </div>
         </div>
