...
global $model;
	...
	if($sq_count1==0)
	{
		...
		while($row_cust=mysql_fetch_assoc($sq_customer)){
			...
			$email = $row_cust['email_id'];
			$contact_no = $row_cust['contact_no'];
			//echo $email;
				email($name,$email);
	...
	$model->app_email_send('72',$email, $content,$subject,'1');
	...
	{
	   global $app_name;
	   $message = "Dear ".$name.", Here's wishing you a grand birthday and many more years of success, prosperity health and happiness, Sincerely ".$app_name." ";
	   global $model;
