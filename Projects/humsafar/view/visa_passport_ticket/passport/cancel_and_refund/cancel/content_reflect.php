		...
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
		            ...
		            $content_arr = array( $sq_passport_info['passport_issue_amount'] ,$sq_passport_info['service_charge'], $sq_passport_info['service_tax_subtotal'], $sq_passport_info['passport_total_cost']);
	...
	<form id="frm_refund">
		...
		<div class="row text-center">
			<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
				<input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_passport_info['cancel_amount'] ?>">
			</div>
