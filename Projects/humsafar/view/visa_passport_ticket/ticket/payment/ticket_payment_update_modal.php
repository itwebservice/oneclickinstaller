...
$enable = ($sq_payment_info['payment_mode']=="Cash") ? "disabled" : "";
?>
         ...
         <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <select name="ticket_id1" id="ticket_id1" style="width:100%" title="Booking ID" disabled>              
			         <option value="<?= $sq_ticket['ticket_id'] ?>"><?= 'TK/'.$year.'/'.$sq_ticket['ticket_id'] ?></option>
              <?php
              ...
              while($row_ticket = mysql_fetch_assoc($sq_ticket)){
                ?>
                <option value="<?= $row_ticket['ticket_id'] ?>"><?= 'TK/'.$year.'/'.$row_ticket['ticket_id'] ?></option>
                <?php
              }
              ?>
            </select>
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="payment_amount1" name="payment_amount1"  class="form-control" placeholder="Amount" title="Amount" value="<?= $sq_payment_info['payment_amount'] ?>" onchange="validate_balance(this.id);">
          </div>          
  ...
  submitHandler:function(form){
    ...
    var base_url = $('#base_url').val();
      ...
      $.ajax({
        ...
        data:{ payment_id : payment_id, ticket_id : ticket_id, payment_date : payment_date, payment_amount : payment_amount, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id, payment_old_value : payment_old_value },
