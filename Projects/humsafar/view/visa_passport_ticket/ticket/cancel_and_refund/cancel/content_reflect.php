            ...
            <div class="widget_parent">
                <div class="stat_content main_block">
                    ...
                    <span class="main_block content_span" data-original-title="" title="">
                        ...
                        <span class="stat_content-amount pull-right" data-original-title="" title=""><?= $sq_ticket_info['basic_cost_markup'] ?></span>
                    </span>   
                </div> 
            </div>
        </div>
        ...
        <div class="widget_parent-bg-img bg-img-purp">
            <div class="widget_parent">
                <div class="stat_content main_block">
                    ...
                    <span class="main_block content_span" data-original-title="" title="">
                        <span class="stat_content-tilte pull-left" data-original-title="" title="">YQ Markup Cost</span>
                        <span class="stat_content-amount pull-right" data-original-title="" title=""><?= $sq_ticket_info['yq_tax_markup'] ?></span>
                    </span>                      
                    <span class="main_block content_span" data-original-title="" title="">
                        <span class="stat_content-tilte pull-left" data-original-title="" title="">YQ Discount</span>
                        <span class="stat_content-amount pull-right" data-original-title="" title=""><?= $sq_ticket_info['yq_tax_discount'] ?></span>
                    </span>                  
                    <span class="main_block content_span" data-original-title="" title="">
                        <span class="stat_content-tilte pull-left" data-original-title="" title="">G1+F2 Tax</span>
                        <span class="stat_content-amount pull-right" data-original-title="" title=""><?= $sq_ticket_info['g1_plus_f2_tax'] ?></span>
                    </span>
                </div> 
            </div>
        </div>
            ...
            <div class="widget_parent">
                <div class="stat_content main_block" style="min-height: 170px;">
                    ...
                    <span class="main_block content_span" data-original-title="" title="">                    
                        ...
                        <span class="stat_content-amount pull-right" data-original-title="" title=""><?= $sq_ticket_info['service_tax_subtotal'] ?></span>
                    </span>                   
                    <span class="main_block content_span" data-original-title="" title="">
                    ...
                    <span class="main_block content_span" data-original-title="" title="">
                        <span class="stat_content-tilte pull-left" data-original-title="" title=""></span>
                        <span class="stat_content-amount pull-right" data-original-title="" title=""></span>
                    </span>
                </div> 
            </div>
        </div>
...
<form id="frm_refund">
	...
	<div class="row text-center mg_tp_10 mg_bt_150">
		<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
			<input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_ticket_info['cancel_amount'] ?>">
		</div>
