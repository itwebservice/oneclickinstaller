...
while($row_ticket = mysql_fetch_assoc($sq_ticket)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('G'.$row_count, $row_ticket['ticket_total_cost'])
        ->setCellValue('H'.$row_count, $cancel_amt)
        ->setCellValue('I'.$row_count, number_format(($row_ticket['ticket_total_cost'] - $cancel_amt), 2))
