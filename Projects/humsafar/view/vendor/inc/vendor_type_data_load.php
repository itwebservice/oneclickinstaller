...
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="hotel_id<?= $offset ?>" id="hotel_id<?= $offset ?>" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="transport_agency_id<?= $offset ?>" id="transport_agency_id<?= $offset ?>" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id<?= $offset ?>" id="vendor_id<?= $offset ?>" title="Select Supplier" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="dmc_id<?= $offset ?>" id="dmc_id<?= $offset ?>" title="Select DMC" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id<?= $offset ?>" id="vendor_id<?= $offset ?>" title="Select Ticket Supplier" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id<?= $offset ?>" id="vendor_id<?= $offset ?>" title="Select Excursion Supplier" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id<?= $offset ?>" id="vendor_id<?= $offset ?>" title="Select Insurance Supplier" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
...
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	...
	<select name="vendor_id<?= $offset ?>" id="vendor_id<?= $offset ?>" title="Select Other Supplier" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="cruise_id<?= $offset ?>" id="cruise_id<?= $offset ?>" style="width:100%">
		<?php 
		if($vendor_type_id==""){
			?>
