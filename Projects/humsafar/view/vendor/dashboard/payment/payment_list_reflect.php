...
<table class="table table-hover" id="tbl_payment_supplier" style="margin: 20px 0 !important;">
	...
	<tfoot>
		<tr class="active">
			...
			<th colspan="3" class="text-right warning">Total Pending : <?= number_format($sq_pending_amount, 2); ?></th>
			<th colspan="3" class="text-right danger">Total Cancel : <?= number_format($sq_cancel_amount, 2); ?></th>
