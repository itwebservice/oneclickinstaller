			...
			if($row_payment['payment_amount'] != '0'){				
			{
				...
				<tr class="<?= $bg;?>">				
					...
					if($row_payment['payment_mode']=="Cash" || $row_payment['payment_mode']=="Cheque"){
						?>
						<input type="checkbox" id="chk_hotel_booking_payment_<?= $count ?>" name="chk_hotel_booking_payment" value="<?= $row_payment['payment_id'] ?>">
						<?php	
					}
					?>					
					</td>
					...
					<td class="success text-right"><?= $row_payment['payment_amount'] ?></td>
					<td>
