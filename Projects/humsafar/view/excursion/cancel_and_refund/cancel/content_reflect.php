		...
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
	                ...
	                $content_arr = array( number_format($exc_amount,2) ,number_format($service_charge,2), number_format($subtotal_amount,2), number_format($sq_exc_info['exc_total_cost'],2));
	                $percent = ($sq_payment_info['sum']/$sq_exc_info['exc_total_cost'])*100;
	                $percent = round($percent, 2);
	                $label = "Excursion Fee Paid In Percent";
...
<form id="frm_refund" class="mg_bt_150">
	...
	<div class="row text-center">
		<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
			<input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_exc_info['cancel_amount'] ?>">
		</div>
