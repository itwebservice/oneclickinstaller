      ...
      <div class="login_wrap_inner">
        ...
        <div class="row">
          ...
          <div class="col-md-1 no-pad">
            <a onclick="show_password('txt_password')" target="_BLANK" class="btn btn-info btn-sm" title="View Password" style="margin-top: 5px;background-color: #009898;"><i class="fa fa-eye"></i></a>
          </div>
        </div><br>
