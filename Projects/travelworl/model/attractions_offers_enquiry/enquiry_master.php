...
function send_enquiry_mail($enquiry_id, $email_id, $name, $tour_name, $enquiry_specification,$assigned_emp_id,$mobile_no){
  global $mail_em_style, $mail_em_style1, $mail_font_family, $mail_strong_style, $mail_color,$app_name;
...
public function enquiry_converted_sms_send($enquiry_id,$name)
{
  ...
  $message = "Dear ".$name.", Thanks for choosing a trip with ".$app_name.". Your relationship manager is ".$first_name." ".$last_name."";
  global $model;
