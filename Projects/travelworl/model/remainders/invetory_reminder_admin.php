...
function email($type,$entry_id){
          ...
          <tr>
            <td>
              <table style="width:100%">
                <tr>
                  <td>
                    <p style="line-height: 24px;margin-bottom: 0px;">Hotel Name : <b>'.$sq_hotel_n['hotel_name'].'</b></p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <p style="line-height: 24px;margin-bottom: 0px;">Total Rooms : <b>'.$sq_hotel['total_rooms'].'</b></p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <p style="line-height: 24px;margin-bottom: 0px;">Available Rooms : <b>'.$avai_rooms.'</b></p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <p style="line-height: 24px;margin-bottom: 0px;">Cancellation Date <b>: '.get_date_user($sq_hotel['cancel_date']).'</b></p>
                  </td>
                </tr>
              </table>
            </td>
  ...
  elseif($type == 'excursion'){
    ...
    $sq_exc = mysql_fetch_assoc(mysql_query("select service_id, service_name from itinerary_paid_services where service_id='$sq_hotel[exc_id]'"));
          ...
          <tr>
            <td>
              <table style="width:100%">
                <tr>
                  <td>
                    <p style="line-height: 24px;margin-bottom: 0px;">Excursion Name : <b>'.$sq_exc['service_name'].'</b></p>
                  </td>
                  </tr>
                  <tr>
                  <td>
                    <p style="line-height: 24px;margin-bottom: 0px;">Total Rooms : <b>'.$sq_hotel['total_tickets'].'</b></p>
                  </td>
                  </tr>
                  <tr>
                  <td>
