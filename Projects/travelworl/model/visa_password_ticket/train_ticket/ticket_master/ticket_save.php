...
class ticket_save{
	...
	public function ticket_master_save(){
		...
		if($GLOBALS['flag']){
			...
			$this->ticket_booking_email_send($train_ticket_id);
	...
	public function ticket_booking_email_send($train_ticket_id)
					...
					<tr>
						...
						<td>
							...
							<p style="line-height:24px">
								...
								<span style="font-weight: bold"> Booking ID : </span> '.get_train_ticket_booking_id($train_ticket_id,$year).'
	...
	';
		...
		global $model,$backoffice_mail_id;
		 ...
		 $model->app_email_send('17',$email_id, $content,$subject);
		 $model->app_email_send('17',$backoffice_mail_id, $content,$subject);
	}
