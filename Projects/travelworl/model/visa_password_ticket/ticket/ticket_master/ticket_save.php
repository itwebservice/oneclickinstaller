...

{
	...
	if($GLOBALS['flag']){
		...
		$this->ticket_booking_email_send($ticket_id);
...
public function ticket_booking_email_send($ticket_id)

{
					...
					<tr>
						...
						<td>
							<p style="line-height:24px">
								...
								<span style="font-weight: bold"> Booking ID : </span> '.get_ticket_booking_id($ticket_id,$year).'
	...
	global $model,$backoffice_email_id;
	 ...
	 $model->app_email_send('16',$email_id, $content,$subject);
	 $model->app_email_send('16',$backoffice_email_id, $content,$subject);
