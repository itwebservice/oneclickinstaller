  ...
  <div class="row">
    <div class="col-md-12">
      <div class="main_block inv_rece_calculation border_block">
        <div class="col-md-6"><p class="border_lt"><span class="font_5">AMOUNT </span><span class="font_5 float_r"><?= $basic_cost1 ?></span></p></div>
        ...
        <div class="col-md-6"><p class="border_lt"><span class="font_5">SERVICE CHARGE </span><span class="float_r"><?= number_format($sq_fields['service_charge'],2) ?></span></p></div>
        ...
        <div class="col-md-6"><p class="border_lt"><span class="font_5">DELIVERY CHARGE </span><span class="float_r"><?php echo number_format( $sq_fields['delivery_charges'],2) ; ?></span></p></div>
        ...
        <div class="col-md-6"><p class="border_lt"><span class="font_5">TAX<?= '('.$service_tax_per.'%)' ?>[<?= $taxation_type ?>] </span><span class="float_r"><?= number_format($service_tax,2) ?></span></p></div> <?php } ?>
      </div>
    </div>
  </div>
</section>
