...

{
	...
	if($sq_app_setting_count == '0'){
		...
		$query = "insert into app_settings ( setting_id, app_version, app_email_id,currency, app_contact_no, app_landline_no,  tax_name, service_tax_no, app_address, app_website, app_name,app_cin, bank_acc_no,acc_name, bank_name, bank_branch_name, bank_ifsc_code, bank_swift_code, policy_url , state_id, accountant_email, tax_type, tax_pay_date, credit_card_charges) values ( '$setting_id', '$app_version', '$app_email_id','$currency_code', '$app_contact_no', '$app_landline_no', '$tax_name', '$service_tax_no', '$app_address', '$app_website', '$app_name','$app_cin', '$bank_acc_no','$acc_name', '$bank_name', '$bank_branch_name', '$bank_ifsc_code', '$bank_swift_code', '$cancel_pdf_url','$state','$acc_email','$tax_type','$tax_pay_date1','$credit_card')";
