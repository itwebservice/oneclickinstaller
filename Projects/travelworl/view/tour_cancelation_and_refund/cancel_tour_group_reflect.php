...
<tr <?php if($status=="disabled"){ ?> class="danger" <?php }?>>
	...
	<td><input class="css-checkbox" type="checkbox" id="chk_tour_group<?php echo $count ?>" value="<?php echo $row['group_id'] ?>" <?php echo $status ?>>   <label for="chk_tour_group<?php echo $count ?>" class="css-label"></label> </td>
</tr>  
<?php
}
?>
