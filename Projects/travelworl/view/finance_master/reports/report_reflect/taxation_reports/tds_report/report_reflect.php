...
<table class="table table-bordered" id="tbl_report_tds_rec" style="margin: 20px 0 !important;">
	<thead>
				...
				if($row_query['tds'] != '0'){			 
				 ?>
					<tr>
						...
						<td><?= $cust_name ?></td>
						<td><?= ($sq_cust['pan_no'] == '') ? 'NA' : $sq_cust['pan_no'] ?></td>
		 ...
		 {		 
			 ...
			 ?>
				<tr>
					<td><?= $count++ ?></td>
					<td><?= get_date_user($row_query['created_at']) ?></td>
					<td><?= $row_query['receipt_from'] ?></td>
					<td><?= ($row_query['pan_no'] == '') ? 'NA' : $row_query['pan_no'] ?></td>
