...
function report_reflect()
{
  ...
  var role = $('#role').val();
	...
	$.post('report_reflect/payable_ageing/report_reflect.php',{ till_date : till_date, vendor_type : vendor_type,vendor_type_id : vendor_type_id , branch_status : branch_status , role : role,branch_admin_id : branch_admin_id }, function(data){
