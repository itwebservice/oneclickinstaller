    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
         ...
         <div class="row"> 
            <div class="col-md-2 col-sm-6 mg_bt_10">
                <select id="cmb_city_id" name="cmb_city_id" class="city_master_dropdown" style="width:100%" title="Select City Name" required>
                    <?php get_cities_dropdown(); ?>
                </select>
            </div>
            <div class="col-md-2 col-sm-6 mg_bt_10">
                <input type="text" class="form-control" id="txt_hotel_name" onchange="validate_spaces(this.id);" name="txt_hotel_name" placeholder="*Hotel Name" title="Hotel Name" required>        
            </div>
            <div class="col-md-2 col-sm-6 mg_bt_10">
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-6 mg_bt_10">
              <select name="hotel_type" id="hotel_type" title="Hotel Type" style='width:100%'>
        ...
        <div class="row">
            <div class="col-md-2 col-sm-6 mg_bt_10">
              <select name="meal_plan" id="meal_plan" title="Meal Plan">
       ...
       <legend>Bank Information</legend>
        ...
        <div class="row">
          <div class="col-sm-2 mg_bt_10">
            <input type="text" id="as_of_date" name="as_of_date" placeholder="*As of Date" title="As of Date" required>
          </div>
          <div class="col-md-2 col-sm-6 mg_bt_10">
            ...
            <div class='row'>
                <div class="col-md-6 col-sm-3 mg_bt_10"> 
                  <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
                    ...
                    <div class="col-md-3 col-sm-3 mg_bt_10">
                        <select name="cwob_from" id="cwob_from" title="Child Without Bed From Age" required>
                    ...
                    <div class="col-md-3 col-sm-3 mg_bt_10">
                        <select name="cwob_to" id="cwob_to" title="Child Without Bed To Age" class='form-control' required>
                ...
                <div class="col-md-6 col-sm-3 mg_bt_10">
                  <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
                    ...
                    <div class="col-md-3 col-sm-3 mg_bt_10">
                        <select name="cwb_from" id="cwb_from" title="Child With Bed From Age" required>
                            <option value=''>*From Age</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
                    ...
                    <div class="col-md-3 col-sm-3 mg_bt_10">
                        <select name="cwb_to" id="cwb_to" title="Child With Bed To Age" class='form-control' required>
                            <option value=''>*To Age</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
    ...
    new AjaxUpload(btnUpload, {
      ...
      onComplete: function(file, response){
        ...
        if(img_array.length>10){
          error_msg_alert("You can upload only 10 images"); return false;
        }
...
$(function(){
  $('#frm_hotel_save').validate({
    rules:{
            cwb_from : { required : true },
            cwb_to : { required : true },
            cwob_from : { required : true },
            cwob_to : { required : true },
    },
