    ...
    <div class="panel panel-default panel-body app_panel_style feildset-panel">
        <legend>Basic Information</legend>
		    ...
		    <div class="row">
		        ...
		        <div class="col-md-2 col-sm-6 mg_bt_10">
		            <input type="text" value="<?= $sq_hotel['hotel_name'] ?>" onchange="validate_spaces(this.id);"  class="form-control" id="txt_hotel_name" name="txt_hotel_name" placeholder="Hotel Name" title="Hotel Name" required>        
		        </div>
      ...
      <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
          ...
          <div class="col-md-2 mg_bt_10">
            <input type="text" id="as_of_date1" name="as_of_date1" placeholder="*As of Date" title="As of Date" value="<?= get_date_user($sq_hotel['as_of_date']) ?>" required>
          </div>
          <div class="col-md-2 mg_bt_10">
            <select name="side" id="side1" title="Select side" disabled required>
