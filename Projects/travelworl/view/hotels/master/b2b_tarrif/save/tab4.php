	...
	submitHandler:function(form){
        ...
        for(var i=0; i<rowCount; i++){
          ...
          if(row.cells[0].childNodes[0].checked){
			  ...
			  var single_bed = row.cells[6].childNodes[0].value;
			  var double_bed = row.cells[7].childNodes[0].value;
			  var triple_bed = row.cells[8].childNodes[0].value;
			  var chwithbed = row.cells[9].childNodes[0].value;
			  var chwobed = row.cells[10].childNodes[0].value;
			  var fchild = row.cells[11].childNodes[0].value;
			  var schild = row.cells[12].childNodes[0].value;
			  var extra_bed = row.cells[13].childNodes[0].value;
			  var queen_bed = row.cells[14].childNodes[0].value;
			  var king_bed = row.cells[15].childNodes[0].value;
			  var quad_bed = row.cells[16].childNodes[0].value;
			  var twin_bed = row.cells[17].childNodes[0].value;
        ...
        for(var i=0; i<rowCount; i++){
          ...
          if(row.cells[0].childNodes[0].checked){
                ...
                var offer_amount = row.cells[6].childNodes[0].value;
