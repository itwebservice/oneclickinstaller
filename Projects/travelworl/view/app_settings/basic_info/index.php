...
<div class="panel panel-default panel-body app_panel_style feildset-panel mg_bt_30">
	...
	<div class="row mg_tp_20">
		...
		<div class="col-md-2 text-right"><label for="app_email_id">Default Currency</label></div>
		<div class="col-md-4">
...
<div class="panel panel-default panel-body app_panel_style feildset-panel mg_bt_30">
	...
	<div class="row mg_tp_20">
		...
		<div class="col-md-4">
			...
			<input type="text" id="bank_name" name="bank_name" placeholder="Bank Name" title="Bank Name" class="bank_suggest" value="<?= $sq_settings['bank_name'] ?>">
...
$(function(){
	...
	$('#frm_basic_info').validate({
		...
		rules:{
				...
				state : { required : true },
				credit_card:	{	max	:	100},
				cin_no:	{ maxlength:	150},
				bank_acc_no:	{maxlength:	20},
				service_tax_no:	{maxlength:	200},
				bank_name:	{ regex: /^[a-zA-Z][a-zA-Z ]+$/ },	
		},
		messages:{
			bank_name:	"Only Alphabets allowed",
		},
