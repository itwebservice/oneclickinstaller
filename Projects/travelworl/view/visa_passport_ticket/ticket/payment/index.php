...
<div class="app_panel_content Filter-panel">
	<div class="row">
		...
		<div class="row text-center">
			<div class="col-xs-12">
				<button class="btn btn-sm btn-info ico_right" onclick="ticket_payment_list_reflect()">Proceed&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>
			</div>
		</div>
</div>

<div id="div_ticket_payment_list" class="main_block loader_parent"></div>
