...
<script type="text/javascript">
	...
	function calculate_total_amount(offset=''){
		...
		var total_amount = parseFloat(passport_issue_amount) + parseFloat(service_charge) + parseFloat(service_tax_subtotal);
		total_amount = total_amount.toFixed(2);
		$('#passport_total_cost'+offset).val(total_amount);
