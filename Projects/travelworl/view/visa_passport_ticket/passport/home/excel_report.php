...
while($row_passport = mysql_fetch_assoc($sq_passport)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('E'.$row_count, $customer_info['contact_no'])
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('F'.$row_count, $total_sale)
        ->setCellValue('G'.$row_count, $total_cancelation_amount)
        ->setCellValue('H'.$row_count, $total_balance)
