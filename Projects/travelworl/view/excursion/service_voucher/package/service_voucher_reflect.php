...
<form id="frm_service_voucher">
  <div class="panel panel-default panel-body">
	<input type="hidden" value="<?= $sq_count ?>" id="count"/>
	<div class="row">
	...
	$(function(){
		$('#frm_service_voucher').validate({
			...
			submitHandler:function(form){
					...
					var count = $('#count').val();
					var booking_type = 'package';
					var note = $('#note').val();

					if(count == 0){
						error_msg_alert("Can not generate Voucher. Excursions does not exist! "); 
						return false;
					}
								...
								$.ajax({
									...
									else
									{
							        	...
							        	if(data1=="yes"){
										var url1 = base_url+'model/app_settings/print_html/voucher_html/fit_excursion_voucher.php?booking_id='+booking_id+'&booking_type='+booking_type;
										loadOtherPage(url1);
									    }
									}
								});
