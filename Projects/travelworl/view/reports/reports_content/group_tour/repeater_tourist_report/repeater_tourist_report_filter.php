...
$query = "select * from travelers_details where 1 and status='Active'";

if($traveler_id!=""){

			$query .=" and traveler_id='$traveler_id'";

		}
if($branch_id!="" && $role!='Branch Admin'){
...
<table class="table trable-hover" id="repeater_tourist" style="margin: 20px 0 !important;">
<thead>
