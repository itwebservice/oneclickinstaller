  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">New Credit Limit</h4>
      </div>
      <div class="modal-body">
        <form id="frm_credit_save">
          <div class="row mg_bt_10">
            <div class="col-sm-3 mg_bt_10_sm_xs">
              <select name="register_id" id="register_id" title="Company" class='form-control' style='width:100%' required>
            ...
            <div class="col-sm-3 mg_bt_10_sm_xs">
              <input type="text" id="app_credit" name="app_credit" placeholder="Credit Amount" title="*Credit Amount" value="<?= $sq_credit['credit_amount'] ?>" onchange="validate_balance(this.id);" required>
            </div>
          </div>
          <div class="row mg_bt_10">
        ...
        callback: function(result){
          if(result=="yes")
          {
            ...
            $.ajax({
              ...
              data:{ register_id : register_id,payment_date:payment_date, credit_limit : credit_limit,description : description,approve_status : approve_status},
