...
<div class="row">
    <div class="col-sm-12 text-right text_left_sm_xs">
        <?php if($role == 'Admin' || $role == 'Branch Admin'){?>
            <button class="btn btn-info btn-sm mg_bt_20 ico_left" id="btn_save_modal" onclick="save_modal();" title="Add New 
        Customer"><i class="fa fa-plus"></i>&nbsp;&nbsp;Credit Limit</button>
        <?php } ?>
    </div>
</div>
