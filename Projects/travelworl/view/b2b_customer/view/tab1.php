		...
		<h3>Address Details</h3>
        	 	...
        	 	<div class="col-md-12 right_border_none_sm" style="min-height: 105px;">
		            ...
		            <span class="main_block">
						  ...
						  <?php echo "<label>Country <em>:</em></label> ".$sq_country['country_name'].'('.$sq_country['country_code'].')'; ?>
		            </span> 
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	...
	<div class="col-md-6">
		...
		<h3>Access Details</h3>
        	 	...
        	 	<div class="col-md-12 right_border_none_sm" style="min-height: 105px;">
		            ...
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Username <em>:</em></label> ".$query['username'] ?>
		            </span>
        	 		<span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Password <em>:</em></label> ".$query['password'] ?>
		            </span>       
		        </div>
		        </div>   
		    </div> 
