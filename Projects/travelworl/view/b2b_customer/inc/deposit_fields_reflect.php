...
?>	 <div class="row">
	 <div class="col-md-12">
		<div class="col-sm-3 mg_bt_10_sm_xs">
			<input type="text" id="deposit" name="deposit" placeholder="*Deposit Amount" title="Deposit Amount" onchange="validate_balance(this.id);" required>
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-3">
			<select name="payment_mode" id="payment_mode" title="Mode" onchange="payment_master_toggles(this.id, 'bank_name', 'transaction_id', 'bank_id')" required>
