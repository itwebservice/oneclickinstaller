        ...
        <input type="hidden" id="register_id" name="register_id" value="<?= $register_id ?>">
          <div class="row mg_bt_10">
            <div class="col-sm-3 mg_bt_10_sm_xs">
              <select name="approve_status1" id="approve_status1" title="Approval Status" onchange="change_fields_status(this.id)" required>
            ...
            <div class="row mg_tp_10">
              ...
              <?php if($sq_customer['approval_status'] == 'Approved'){ ?>
                <div class="col-sm-3 mg_bt_10_sm_xs">
                  <input type="text" id="deposit" name="deposit" placeholder="*Deposit Amount" title="Deposit Amount" value="<?= $sq_customer['deposite'] ?>" onchange="validate_balance(this.id);" required>
                </div>
                <div class="col-md-3">
                  <input type="text" id="payment_date" name="payment_date" placeholder="*Date" title="Date" value="<?= get_date_user($sq_customer['payment_date']) ?>" onchange="check_valid_date(this.id)" <?= $payment_dates ?> required>
                </div>
                <div class="col-md-3">
                  <select name="payment_mode" id="payment_mode" title="Mode" onchange="payment_master_toggles(this.id, 'bank_name', 'transaction_id', 'bank_id')" <?= $payment_modes ?> required>
