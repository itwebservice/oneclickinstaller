<form id="frm_updatetab2">
  ...
  <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
      ...
      <div class="row text-center mg_tp_10">
          <div class="col-md-3 col-sm-6">
              <input class="form-control" type="text" id="username" name="username" placeholder="*Username" title="Username" value="<?= $sq_query['username'] ?>" required> 
          </div>
          <div class="col-md-3 col-sm-6">
              <input class="form-control" type="password" id="password" name="password" placeholder="*Password" title="Password" value="<?= $sq_query['password'] ?>" required> 
          </div>
          <div class="col-md-3 col-sm-6">
              <input class="form-control" type="password" id="repassword" name="repassword" placeholder="*ReType Password"  title="ReType Password" value="<?= $sq_query['password'] ?>" required>
          </div>
      </div>
  </div>
...
$('#frm_updatetab2').validate({
  ...
  submitHandler:function(form){
      ...
      data:{ register_id:register_id,company_old:company_old,company_name : company_name, acc_name : acc_name, iata_status : iata_status, iata_reg : iata_reg, nature : nature, currency : currency, telephone : telephone, latitude : latitude, turnover_slab : turnover_slab, skype_id : skype_id, website : website, 
      ...
      success: function(message){
             message = message.trim();
                if(message == 'error--The Company has already been taken..'){
