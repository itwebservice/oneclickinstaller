<form id="frm_tab2">
  <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
      ...
      <div class="row text-center mg_tp_10">
        <div class="col-md-3 col-sm-6">
            <input class="form-control" type="text"  id="whatsapp_no" name="whatsapp_no" placeholder="Whatsap No" title="Whatsap No">
        </div>
        <div class="col-md-3 col-sm-6">
  ...
  <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
      ...
      <div class="row text-center mg_tp_10">
          ...
          <div class="col-md-3 col-sm-6">
              <input class="form-control" type="password" id="repassword" name="repassword" placeholder="*ReType Password"  title="ReType Password" required >
          </div>
      </div>
  </div>
