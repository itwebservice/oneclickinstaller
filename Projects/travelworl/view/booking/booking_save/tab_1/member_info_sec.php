...
<tr>
    <td><input class="css-checkbox" id="check-btn-member-1" type="checkbox" onchange="payment_details_reflected_data('tbl_member_dynamic_row')" checked ><label class="css-label" for="check-btn-member-1"></label>
    </td>
    ...
    <td style="width: 130px;"><input type="text" id="txt_m_passport_issue_date" name="txt_m_passport_issue_date" placeholder="Issue Date" title="Passport Issue Date" class="app_datepicker" onchange="payment_details_reflected_data('tbl_member_dynamic_row')" disabled></td>

    <td style="width: 132px;"><input type="text" id="txt_m_passport_expiry_date" name="txt_m_passport_expiry_date" placeholder="Expire Date" title="Passport Expire Date" class="app_datepicker" onchange="payment_details_reflected_data('tbl_member_dynamic_row')" disabled></td>
