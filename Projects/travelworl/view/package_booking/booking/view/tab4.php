		 ...
		 <div class="profile_box main_block" style="min-height: 141px;">
	        ...
	        <div class="row">
				...
				<div class="col-sm-6 col-xs-12">
	        	    <span class="main_block">
	        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	        	      <?php echo "<label>".get_tax_name()." Amount <em>:</em></label> ".$sq_package_info['plane_service_tax_subtotal']; ?>
	        	    </span>
	        	    <span class="main_block">
	        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		...
		<div class="profile_box main_block" style="min-height: 141px;">
	        ...
	        <div class="row">
	            <div class="col-sm-6 col-xs-12 right_border_none_sm_xs" style="border-right: 1px solid #ddd">
		        	...
		        	<span class="main_block">
		        	  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		        	  <?php echo "<label>Markup  <em>:</em></label> ".$sq_package_info['total_tour_expense']; ?>
		        	</span>
				    <span class="main_block">
				      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
				    ...
				    <span class="main_block">
	        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	        	      <?php echo "<label>Currency <em>:</em></label> ".$sq_currency['currency_name'].'('.$sq_package_info['currency_code'].')'; ?>
	        	    </span>
				</div>
	        	...
	        	<?php   
	        	    ...
	        	    <span class="main_block">
	        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	        	      <?php echo "<label>".get_tax_name()." Amount<em>:</em></label> ".$sq_package_info['tour_service_tax_subtotal']; ?>
	        	    </span>
	        	    <span class="main_block">
	        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		        	    ...
		        	    <span class="main_block">
		        	      ...
		        	      <?php echo "<label>Tour Amount <em>:</em></label> "?><em class="theme_col"><?php echo $sq_package_info['actual_tour_expense']; ?> </em>
	       		        ...
	       		        <span class="main_block" style="min-width: 161px;height: 28px;border: 1px solid #62dac4;background-color: #52c5c5;color: white;text-align:center;padding-top: 3px;">
		        	      	<?php echo "<label>Booking Amount <em>:</em></label> ".($sq_package_info['actual_tour_expense'] + $sq_package_info['total_travel_expense']); ?> 
		        	    </span>
		        	</div>
				</div>
	        </div>
