	      ...
	      success:function(result){
					...
					if(table.rows.length == 1){
						...
						for(var i=0; i<hotel_arr.length; i++){
							...
							row.cells[5].childNodes[0].value = hotel_arr[i]['hotel_type'];
							row.cells[6].childNodes[0].value = hotel_arr[i]['total_days'];
							row.cells[7].childNodes[0].value = total_rooms;
							row.cells[8].childNodes[0].value = extra_bed;
							
							extra_bed_cost = parseFloat(hotel_arr[i]['extra_bed_cost']) * parseFloat(extra_bed);
							
							row.cells[9].childNodes[0].value = hotel_arr[i]['package_name'];
							row.cells[10].childNodes[0].value = hotel_arr[i]['hotel_cost'];
							row.cells[11].childNodes[0].value = hotel_arr[i]['package_id'];
