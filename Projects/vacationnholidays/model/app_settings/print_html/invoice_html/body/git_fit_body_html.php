  ...
  <div class="row">
    <div class="col-md-12">
      <div class="main_block inv_rece_calculation border_block">
        <div class="col-md-4"><p class="border_lt"><span class="font_5">NET AMOUNT </span><span class="font_5 float_r"><?php echo number_format($net_amount,2); ?></span></p></div>
        <div class="col-md-4"><p class="border_lt"><span class="font_5">PAID AMOUNT </span><span class="float_r"><?php echo number_format($total_paid,2); ?></span></p></div>
        <div class="col-md-4"><p class="border_lt no-marg"><span class="font_5">BALANCE AMOUNT </span><span class="font_5 float_r"><?php echo number_format($total_balance,2); ?></span></p></div>
      </div>
    </div>
  </div>
</section>
