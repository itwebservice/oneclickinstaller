...
elseif($role!='Admin' && $role!='Branch Admin' && $role_id!='7' && $role_id<'7'){
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('H'.$row_count, "Travelling Date&Time")
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('H'.$row_count, date('d-m-Y H:i:s', strtotime($row_booking['traveling_date'])))
        ->setCellValue('I'.$row_count, number_format($row_booking['total_fees'],2))
