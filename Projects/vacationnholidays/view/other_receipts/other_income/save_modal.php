      ...
      if(data !== 'valid'){
        ...
        if(data !== 'valid'){
          ...
          $.ajax({
            ...
            data: { income_type_id : income_type_id,r_from : r_from, sub_total : sub_total, taxation_type : taxation_type, service_tax : service_tax,taxation_id : taxation_id, service_tax_subtotal : service_tax_subtotal, tds : tds, net_total : net_total, particular : particular, booking_date : booking_date, payment_amount : payment_amount, payment_date : payment_date, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id, cust_pan_no : cust_pan_no,branch_admin_id : branch_admin_id},
