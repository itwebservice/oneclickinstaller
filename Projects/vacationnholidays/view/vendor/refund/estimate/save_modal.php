    ...
    <div class="modal-content">
              ...
              <div class="simple_multiple_stat">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="col5">
                      Basic Cost<br>
                      <span><?= $sq_est_info['basic_cost'] ?></span>
                    </div>
                    <div class="col5">
                      Non-Recoverable Taxes<br>
                      <span><?= $sq_est_info['non_recoverable_taxes'] ?></span>
                    </div>
                    <div class="col5">
                      Service Charge<br>
                      <span><?= $sq_est_info['service_charge'] ?></span>
                    </div>
                    <div class="col5">
                      Other Charges<br>
                      <span><?= $sq_est_info['other_charges'] ?></span>
                    </div>
                    <div class="col5">
                      Service Tax<br>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="col5">
                      Discount<br>
                      <span><?= $sq_est_info['discount'] ?></span>
                    </div>
                    <div class="col5">
                      Commission<br>
                      <span><?= $sq_est_info['our_commission'] ?></span>
                    </div>
                    <div class="col5">
                      TDS<br>
                      <span><?= $sq_est_info['tds'] ?></span>
                    </div>
                    <div class="col5">
                      Total<br>
                      <span><strong style="color:#fff;"><?= $sq_est_info['net_total'] ?></strong></span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row text-center">
        <div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
          <input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_est_info['cancel_amount'] ?>">
        </div>
