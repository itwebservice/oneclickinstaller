	...
	<?php
		...
		while($row_visa = mysql_fetch_assoc($sq_visa)){
			...
			<tr class="<?= $bg ?>">
				...
				<td>
					<button class="btn btn-info btn-sm" onclick="visa_view_modal(<?= $row_visa['misc_id'] ?>)" title="View Detail"><i class="fa fa-eye" aria-hidden="true"></i></button>
				</td>	
				<td class="info text-right"><?= number_format($row_visa['misc_issue_amount'],2) ?></td>
				...
				<td>
					<button class="btn btn-info btn-sm" onclick="payment_view_modal(<?= $row_visa['misc_id'] ?>)" title="View Detail"><i class="fa fa-eye" aria-hidden="true"></i></button>
				</td>
				<td class="warning text-right" text-right><?= number_format($bal, 2); ?></td>
				<td><?php echo $due_date; ?></td>
				<td><?php echo number_format($total_purchase,2); ?></td>
				<td>
					<button class="btn btn-info btn-sm" onclick="supplier_view_modal(<?= $row_visa['misc_id'] ?>)" title="View Detail"><i class="fa fa-eye" aria-hidden="true"></i></button>
				</td>
