	...
	<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
	                $title_arr = array("Booking Amount", "Service Charge", "Delivery Charge","Tax","Total Amount");
	                $content_arr = array( $sq_train_ticket_info['basic_fair'] , $sq_train_ticket_info['service_charge'],$sq_train_ticket_info['delivery_charges'], $sq_train_ticket_info['service_tax_subtotal'],$sq_train_ticket_info['net_total']);
...
<form id="frm_refund" class="mg_bt_150">
	...
	<div class="row text-center">
		<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
			<input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_train_ticket_info['cancel_amount'] ?>">
		</div>
