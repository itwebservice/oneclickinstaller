      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="entity_id" id="entity_id1" value="<?php echo $sq_checklist['entity_id'];?>">
          ...
          <div class="col-sm-4 mg_bt_30">
            <select name="entity_for" class="form-control" id="entity_for1" title="For" disabled="" >
        ...
        <div class="row mg_bt_10"> <div class="col-md-12 text-right">
          ...
          <div class="row"> <div class="col-md-12"> 
            <table id="tbl_dynamic_tour_name_update" name="tbl_dynamic_tour_name_update" class="table table-bordered table-hover no-marg"  cellspacing="0">
              ...
              ?>
              <tr>
                  <td class="col-md-1"><input id="chk_tour_group1" type="checkbox" class="form-control" checked disabled></td>
  ...
  $('#frm_entity_update').validate({
    ...
    submitHandler:function(form){
      ...
      $.ajax({
        ...
        data:{entity_name_arr : entity_name_arr,entity_id : entity_id,entry_id_arr : entry_id_arr},
