...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('J'.$row_count, "Cancel Amount")
...
$count = 0;
	...
	$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('I'.$row_count, number_format($row_booking['net_total'],2))
        ->setCellValue('J'.$row_count, number_format($row_booking['cancel_amount'],2))
        ->setCellValue('K'.$row_count, number_format($row_booking['net_total'] - $row_booking['cancel_amount'],2))
