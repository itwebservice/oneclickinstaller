        ...
        <table class="table table-bordered table-hover no-marg" id="tbl_traveler_cancel">
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr <?php if($status=="disabled"){ ?> style="color:grey" <?php } ?>>
                        ...
                        <td><input type="checkbox" class="traveler_names" value="<?php echo $row['traveler_id'] ?>" id="<?php echo "chk_traveler_member_id".$counter ?>" name="chk_traveler_member_id" <?php echo $status ?>> <label for="<?php echo "chk_traveler_member_id".$counter ?>" class="css-label"></label></td>
