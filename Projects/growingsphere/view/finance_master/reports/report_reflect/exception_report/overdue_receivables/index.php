...
function report_reflect_r()
{
	...
	var role = $('#role').val();
	$.post(base_url+'view/finance_master/reports/report_reflect/exception_report/overdue_receivables/report_reflect.php',{ party_name : party_name, branch_status : branch_status , role : role,branch_admin_id : branch_admin_id}, function(data){
