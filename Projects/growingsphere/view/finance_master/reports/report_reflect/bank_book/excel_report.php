...
if($bank_id != ''){
  $sq_bank = mysql_fetch_assoc(mysql_query("select * from bank_master where bank+id='$bank_id'"));
...
$objPHPExcel->setActiveSheetIndex(0)
      ...
      ->setCellValue('K'.$row_count, 'Opening Balance')
      ->setCellValue('L'.$row_count, number_format($opening_bal, 2));
