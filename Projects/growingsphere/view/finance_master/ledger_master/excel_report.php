...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('C'.$row_count, "Alias_Name")

        ->setCellValue('D'.$row_count, "Group_Name")
...
while($row_gl = mysql_fetch_assoc($sq_gl)){
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('C'.$row_count, $row_gl['alias'])

        ->setCellValue('D'.$row_count, $sq_sl['subgroup_name'])

        ->setCellValue('E'.$row_count, number_format($balance,2).$side_t1);
