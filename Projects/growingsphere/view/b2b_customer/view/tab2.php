		...
		<h3>Contact Person Details</h3>
        	<div class="row">
        	 	<div class="col-md-6 right_border_none_sm" style="min-height: 105px;">
		            ...
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Email Id<em>:</em></label> ".$query['cp_last_name'] ?>
		            </span>
        	 		<span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Mobile No <em>:</em></label> ".$query['iata_status'] ?>
		            </span>
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Whatsapp No <em>:</em></label> ".$query['iata_reg_no']; ?>
		            </span>
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Designation <em>:</em></label> ".$query['nature_of_business']; ?>
		            </span> 
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>PAN Card No. <em>:</em></label>".$sq_currency['currency_name'] ?>
		            </span>
					<?php
