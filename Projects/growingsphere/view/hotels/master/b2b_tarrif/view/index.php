    ...
    <div class="modal-content">
      ...
      <div class="modal-body profile_box_padding">
      	...
      	<div>
			...
			<li role="presentation"><a href="#contracted" aria-controls="profile" role="tab" data-toggle="tab" class="tab_name">Contracted Tariff</a></li>
			...
			<li role="presentation"><a href="#offers" aria-controls="profile" role="tab" data-toggle="tab" class="tab_name">Offers/Discounts/Coupon</a></li>
			...
			<div class="tab-content responsive">
				...
				<!-- ********Tab1 End******** -->
				<!-- ***Tab2 Start*** -->
				<div role="tabpanel" class="tab-pane no-pad-sm" id="contracted">
