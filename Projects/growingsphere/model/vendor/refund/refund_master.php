...
public function finance_save($refund_id)
{
    ...
    $payment_particular = get_refund_charges_particular(get_vendor_estimate_id($estimate_id,$yr1),get_vendor_refund_id($refund_id,$yr1),$payment_mode);
    $ledger_particular = '';
    $gl_id = $pay_gl;
    $payment_side = "Debit";
    $clearance_status = "";
...
public function bank_cash_book_save($refund_id)
{
	...
	$bank_id = $bank_id;
	$particular = get_refund_charges_particular(get_vendor_estimate_id($estimate_id,$yr1),get_vendor_refund_id($refund_id,$yr1),$payment_mode1);
	$clearance_status = ($payment_mode=="Cheque") ? "Pending" : "";
	$payment_side = "Debit";
