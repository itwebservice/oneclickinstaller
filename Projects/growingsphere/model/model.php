...
$connection=mysql_connect("localhost","itourscl_grow_u","NvE,,.WL,O6c");
if(!$connection){ echo "Unable To make Connection."; }

$db_connect=mysql_select_db("itourscl_growing_sphere");
if(!$db_connect) { echo "Database Not Connected."; } 

define('BASE_URL', 'https://gs.itourscloud.com/');
