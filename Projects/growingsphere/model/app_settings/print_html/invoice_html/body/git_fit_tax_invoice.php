           ...
           <div class="table-responsive">
            <table class="table no-marg mg_tp_5 gst_invoice" style="padding: 0 !important;">  
              <tr>  
                ...
                <td class="text-right col-md-4"><?= $total_amt_before_tax ?></td> 
              </tr> 
              <tr>  
                <td class="text-right col-md-8">Add : CGST <?php if($taxation_type=="SGST CGST"){ ?>@<?= $tour_service_tax/2 ?>%<?php } ?> :</td> 
                <td class="text-right col-md-4"><?php if($taxation_type=="SGST CGST"){ echo $tour_cgst_sgst; } ?></td>  
              </tr> 
              <tr>  
              ...
              <tr>  
                ...
                <td class="text-right col-md-4"><?php if($taxation_type=='IGST'){ echo $total_service_tax_subtotal; } ?></td> 
              </tr> 
              <tr>  
                <td class="text-right col-md-8">Add : UGST <?php if($taxation_type=="UGST"){ ?>@<?= $tour_service_tax ?>%<?php } ?> :</td>  
                <td class="text-right col-md-4"><?php if($taxation_type=='UGST'){ echo $total_service_tax_subtotal; } ?></td> 
              </tr> 
              <tr>  
                <td class="text-right col-md-8">Tax Amount : GST @<?= $tour_service_tax ?>% :</td>  
                <td class="text-right col-md-4"><?php echo $total_service_tax_subtotal ?></td>  
              </tr> 
              <tr class="hightlited_row"> 
