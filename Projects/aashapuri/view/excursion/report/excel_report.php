...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('H'.$row_count, "Total Guest")
...
$row_count++;
        ...
        while($row_exc =mysql_fetch_assoc($sq_exc))
        {
            ...
            while($row_entry = mysql_fetch_assoc($sq_entry))
            {
                ...
                $sq_exc1 = mysql_fetch_assoc(mysql_query("select * from itinerary_paid_services where service_id='$row_entry[exc_name]'"));
                ...
                ->setCellValue('G'.$row_count, $sq_exc1['service_name'] )
                ->setCellValue('H'.$row_count, $total)
                ->setCellValue('I'.$row_count, number_format($row_entry['total_cost'],2));
