...
$query .= " order by passport_id desc ";
 ...
 $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('L'.$row_count, "Sale")
                ->setCellValue('M'.$row_count, "Cancel")
                ->setCellValue('N'.$row_count, "Total")
                ->setCellValue('O'.$row_count, "Paid")
                ->setCellValue('P'.$row_count, "Outstanding Balance")
                ->setCellValue('Q'.$row_count, "Due_Date")
...
$count = 0;     
	    ...
	    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('K'.$row_count, number_format($row_passport['service_tax_subtotal'],2))
            ->setCellValue('L'.$row_count, number_format($row_passport['passport_total_cost'],2))
            ->setCellValue('M'.$row_count, number_format($cancel_amount,2))
            ->setCellValue('N'.$row_count, number_format($total_bal,2))
            ->setCellValue('O'.$row_count, number_format($paid_amount,2))
            ->setCellValue('P'.$row_count, number_format($bal_amount,2))
            ->setCellValue('Q'.$row_count, ($row_passport['due_date'] == '1970-01-01') ? 'NA' : get_date_user($row_passport['due_date']))
        ...
        ->setCellValue('M'.$row_count, 'TOTAL SALE :'.number_format($sale_total,2))
