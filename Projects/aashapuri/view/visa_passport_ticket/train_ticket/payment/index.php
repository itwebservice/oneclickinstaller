...
<div class="app_panel_content Filter-panel">
	...
	<div class="row">
		<div class="col-md-6 text-right">
			<button class="btn btn-sm btn-info ico_right" onclick="train_ticket_payment_list_reflect()">Proceed&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>
		</div>
	</div>
</div>

<div id="div_train_ticket_payment_list" class="main_block"></div>
