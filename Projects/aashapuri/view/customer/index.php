    ...
    <div class="login_wrap">
      ...
      <div class="login_wrap_inner">
        ...
        <div class="row"> <div class="col-md-12"> 
              <input class="form-control" id="txt_mobile_no" name="txt_mobile_no" type="text" maxlength="30" placeholder="Mobile Number" onchange="mobile_validate(this.id)" required/>
        </div> </div><br>

        <div class="row"> <div class="col-md-12"> 
              <input class="form-control" id="txt_email_id" name="txt_email_id" type="password" maxlength="30" placeholder="Email Id" onchange="number_validate(this.id)" required/>
        </div> </div> <br>
