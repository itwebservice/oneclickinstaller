...
{	
	...
	?>
		<tr>
			...
			<td>
				<button class="btn btn-info btn-sm" onclick="view_modal('<?php echo implode(',', $booking_id_arr); ?>','<?php echo implode(',', $pending_amt_arr); ?>','<?php echo implode(',', $not_due_arr); ?>','<?php echo implode(',',$total_days_arr); ?>','<?php echo implode(',', $due_date_arr); ?>')" title="Party Information"><i class="fa fa-eye"></i></button>
			</td>
