...
foreach($enquiry_content_arr1 as $enquiry_content_arr2){
	...
	if($enquiry_content_arr2['name']=="traveling_date"){ $sq_enq['traveling_date'] = get_date_user($enquiry_content_arr2['value']); }
...
$sq_enq['enquiry_date'] = get_date_user($sq_enq['enquiry_date']);
