...
$objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('L'.$row_count, "Total Sale")
                ...
                ->setCellValue('R'.$row_count, "Purchased_From")
	    ...
	    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L'.$row_count, number_format($total_sale,2))
            ...
            ->setCellValue('P'.$row_count, number_format($bal,2))
