        ...
        <table id="tbl_package_tour_quotation_dynamic_train" name="tbl_package_tour_quotation_dynamic_train" class="table table-bordered pd_bt_51">
        	...
        	if($sq_train_count==0){
				...
				<tr>
		            ...
		            <td class="col-md-2"><input type="text" id="train_departure_date1"  name="train_departure_date" placeholder="Departure Date" title="Departure Date" class="app_datetimepicker" value="<?= date('d-m-Y H:i:s') ?>" onchange="get_to_datetime(this.id,'train_arrival_date1')"></td>
		            <td class="col-md-2"><input type="text" id="train_arrival_date1" name="train_arrival_date" placeholder="Arrival Date" title="Arrival Date" class="app_datetimepicker" value="<?= date('d-m-Y H:i:s') ?>"></td>
	            </tr>    
	            <script>
        		...
        		while($row_q_train = mysql_fetch_assoc($sq_q_train)){
					...
					<tr>
			            ...
			            <td class="col-md-2"><input type="text" id="train_departure_date<?= $count ?>_u" name="train_departure_date" placeholder="Departure Date" title="Departure Date" class="app_datetimepicker" value="<?= get_datetime_user($row_q_train['departure_date']) ?>" onchange="get_to_datetime(this.id,'train_arrival_date<?= $count ?>_u')"></td>
