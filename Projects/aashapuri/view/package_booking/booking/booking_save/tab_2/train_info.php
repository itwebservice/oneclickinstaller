<div class="row mg_bt_10" >
    <div class="col-md-4 col-sm-6">
        <input type="checkbox" id="chk_train_select_all" onchange="select_all('tbl_train_travel_details_dynamic_row',this.id);  calculate_train_expense('tbl_train_travel_details_dynamic_row')" checked>&nbsp;&nbsp;<label for="chk_train_select_all">Select All</label>
    </div>
    <div class="col-md-8 col-sm-6 text-right">
        ...
        <button type="button" class="btn btn-pdf btn-sm" onClick="deleteRow('tbl_train_travel_details_dynamic_row');calculate_train_expense('tbl_train_travel_details_dynamic_row');" title="Delete Row"><i class="fa fa-trash"></i></button>
...
<div class="row mg_bt_30"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    <table id="tbl_train_travel_details_dynamic_row" name="tbl_train_travel_details_dynamic_row" class="table table-bordered table-hover table-striped pd_bt_51 no-marg" style="width: 1400px;">
        <tr>
            <td><input id="check-btn-train-1" type="checkbox" onchange="calculate_train_expense('tbl_train_travel_details_dynamic_row')" checked ></td>
            ...
            <td><select id="txt_train_from_location1" name="txt_train_from_location1" class="app_select2" style="width:150px" title="From Location" onchange="validate_location('txt_train_from_location1' , 'txt_train_to_location1');">
            ...
            <td><select id="txt_train_to_location1" name="txt_train_to_location1" onchange="validate_location('txt_train_to_location1' , 'txt_train_from_location1')" class="app_select2" style="width:150px" title="To Location">
            ...
            <td style="width: 130px;"><input type="text" id="txt_train_amount1" name="txt_train_amount1" placeholder="*Amount" title="Amount" onchange="validate_balance(this.id);" onkeyup=" calculate_train_expense('tbl_train_travel_details_dynamic_row');" /></td>
