...
$sq_booking = mysql_query($query);
    ...
    while($row_booking = mysql_fetch_assoc($sq_booking)){
      ...
      //Tour TOtal
      $tour_amount= ($row_booking['actual_tour_expense']!="") ? $row_booking['actual_tour_expense']: 0;
      ...
      $total_booking_amt = $total_tour_amount + $total_travel_amount;
      ...
      $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('L'.$row_count, number_format($row_booking['tour_service_tax_subtotal'],2))
        ...
        ->setCellValue('O'.$row_count, number_format($total_tour_amount, 2))
        ...
        ->setCellValue('S'.$row_count,  ($row_booking['due_date']=='1970-01-01') ? 'NA' : date('d-m-Y',strtotime($row_booking['due_date'])))
