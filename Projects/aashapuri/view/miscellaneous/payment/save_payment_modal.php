      ...
      if(data !== 'valid'){
        ...
        $('#btn_save_payment').button('loading');
          ...
          $.ajax({
            ...
            data:{ misc_id : misc_id, payment_date : payment_date, payment_amount : payment_amount, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id, branch_admin_id : branch_admin_id },
