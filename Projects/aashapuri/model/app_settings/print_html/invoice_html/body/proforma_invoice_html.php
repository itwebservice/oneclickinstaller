  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="main_block inv_rece_calculation border_block">
        ...
        <div class="col-md-12"><p class="border_lt"><span class="font_5">TAX</span><span class="float_r"><?= $service_tax1 ?></span></p></div>
        ...
        <?php } ?>
        <div class="col-md-12"><p class="border_lt"><span class="font_5">TOTAL </span><span class="font_5 float_r"><?= number_format($net_amount,2) ?></span></p></div>
      </div>
    </div>
  </div>
