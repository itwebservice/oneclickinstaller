...
?>
    ...
    <section class="print_header main_block">
      ...
      <span class="title"><i class="fa fa-file-text"></i> GROUP TOUR</span>
            ...
            <ul class="main_block noType">
              ...
              <li class="col-md-3 mg_tp_10 mg_bt_10">
                <div class="print_quo_detail_block">
                  ...
                  <span>PRICE</span><br>
                  <?php echo number_format($tour_total_amount + $tourwise_details['total_travel_expense'],2); ?><br>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-5 mg_bt_20">
          <ul class="print_info_list no-pad noType">
            ...
            <li><span>CONTACT NUMBER :</span><?php echo $sq_customer['contact_no']; ?></li>
          </ul>
        </div>
      </div>
      <div class="row">
    ...
    <section class="print_sec main_block">
        ...
        <div class="col-md-12">
          <div class="print_amount_block">
            <ul class="main_block no-pad text-right noType">
              ...
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>TAX AMOUNT : </span><?php echo number_format($tourwise_details['service_tax'],2); ?></li>
            </ul>
            <ul class="main_block no-pad text-right noType">
            ...
            <ul class="main_block no-pad text-right noType">
              ...
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>VISA AMOUNT : </span><?php echo number_format($tourwise_details['visa_total_amount'],2); ?></li>
            </ul>
            <ul class="main_block no-pad text-right noType">
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>INSURANCE AMOUNT : </span><?php echo number_format($tourwise_details['insuarance_total_amount'],2); ?></li>
            </ul>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="print_amount_block">
            <ul class="main_block no-pad text-right noType">
              <li class="col-md-12 mg_tp_10 mg_bt_10 font_5"><span>TOTAL AMOUNT : </span><?php echo number_format($tour_total_amount + $tourwise_details['total_travel_expense'],2); ?></li>
            </ul>
          </div>
        </div>
      </div>
