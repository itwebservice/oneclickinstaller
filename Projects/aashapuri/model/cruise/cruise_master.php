...
public function cruise_save()
{
	...
	$sq_cruise = mysql_query("insert into cruise_master (cruise_id, city_id, company_name, mobile_no, landline_no, email_id, contact_person_name,immergency_contact_no, cruise_address, country, website, opening_balance, bank_name,account_name,account_no,branch,ifsc_code, service_tax_no, active_flag, created_at,side,pan_no,as_of_date) values ('$cruise_id', '$cmb_city_id', '$company_name', '$mobile_no', '$landline_no', '$email_id', '$contact_person_name','$immergency_contact_no' ,'$cruise_address','$country','$website', '$opening_balance','$bank_name','$account_name','$account_no','$branch','$ifsc_code','$service_tax_no', '$active_flag', '$created_at','$side','$supp_pan','$as_of_date' ) ");
