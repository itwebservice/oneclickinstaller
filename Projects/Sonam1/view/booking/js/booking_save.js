...
function whatsapp_send(tour_id, customer_id,tour_group_id, emp_id){
	$.post($('#base_url').val()+"controller/group_tour/booking/whatsapp_send.php",{tour_id:tour_id, customer_id:customer_id,tour_group_id:tour_group_id,emp_id:emp_id}, function(data){
		window.open(data);
	});
}
