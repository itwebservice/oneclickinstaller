		...
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
	                ...
	                $content_arr = array( number_format($sq_hotel_info['sub_total']+$sq_hotel_info['markup'],2) , $sq_hotel_info['service_charge'], $sq_hotel_info['service_tax_subtotal'],$sq_hotel_info['discount'],$sq_hotel_info['tds'], $sq_hotel_info['total_fee']);
