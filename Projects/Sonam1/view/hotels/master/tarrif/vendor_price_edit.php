...
$('#frm_bid_update').validate({
	...
	submitHandler:function(form){
		...
		$.ajax({
			...
			data:{ from_date : from_date, to_date : to_date, single_bed_cost : single_bed_cost, double_bed_cost : double_bed_cost, triple_bed_cost : triple_bed_cost, with_bed_cost: with_bed_cost,without_bed_cost : without_bed_cost,currency_code : currency_code, quad_bed_cost : quad_bed_cost,queen : queen, king : king, twin : twin, meal_plan : meal_plan, price_entry : price_entry},
