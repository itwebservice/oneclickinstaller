              ...
              if(result=="yes"){
                ...
                $.post(base_url+"controller/custom_packages/package_master_save.php",
                   ...
                   { tour_type:tour_type,dest_id : dest_id,currency_id:currency_id, taxation_type :      
                     taxation_type, taxation_id:taxation_id,service_tax : service_tax, package_code : package_code, package_name : package_name, total_days : total_days1, total_nights : total_nights, status : status, city_name_arr : city_name_arr, hotel_name_arr : hotel_name_arr, hotel_type_arr : hotel_type_arr, total_days_arr : total_days_arr,vehicle_name_arr:vehicle_name_arr,cost_name_arr:cost_name_arr,child_cost : child_cost,adult_cost : adult_cost,infant_cost: infant_cost,child_with : child_with,child_without: child_without,extra_bed:extra_bed,inclusions : inclusions, exclusions : exclusions, day_program_arr : day_program_arr, special_attaraction_arr : special_attaraction_arr,overnight_stay_arr : overnight_stay_arr,meal_plan_arr : meal_plan_arr},
