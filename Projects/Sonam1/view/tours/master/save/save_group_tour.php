...
$('#airline_name1,#airline_name-1,#plane_from_location1,#plane_to_location1,#plane_to_location-1,#plane_from_location-1').select2();
$('#train_from_location1,#train_to_location1,#from_city-1,#to_city-1').select2({minimumInputLength: 1});

$('#plane_from_location1,#plane_to_location1,#train_to_location1,#airline_name1,#from_city-1,#plane_from_location-1,#to_city-1,#plane_to_location-1,#airline_name-1').select2();
