    ...
    <table id="tbl_activities" name="tbl_activities" class="table border_0 table-hover no-marg">
        ...
        ?>
            <tr>
                ...
                <td><input maxlength="15" value="1" type="text" name="no" placeholder="Sr. No." class="form-control" disabled /></td>
                <td><select name="city_name-1" id="city_name-1" title="Select City" onchange="excursion_dynamic_reflect(this.id)" style="width:100%" class="form-control app_select2">
                        <?php if($city_id!=''){ ?>
                        <option value="<?= $sq_city['city_id'] ?>"><?= $sq_city['city_name'] ?></option>
                        <?php } ?>
                        <?php get_cities_dropdown() ?>
        ...
        <?php }
            ...
            <tr>
                ...
                <td><input maxlength="15" value="<?=($i+1)?>" type="text" name="no" placeholder="Sr. No." class="form-control" disabled /></td>
                <td><select name="city_name-1<?=$i?>_u" id="city_name-1<?=$i?>_u" title="Select City" onchange="excursion_dynamic_reflect(this.id)" style="width:100%" class="form-control app_select2">
                        <?php if($city_id!=''){ ?>
                        <option value="<?= $sq_city['city_id'] ?>"><?= $sq_city['city_name'] ?></option>
                        <?php } ?>
                        <?php get_cities_dropdown() ?>
    ...
    <table id="tbl_hotels" name="tbl_hotels" class="table border_0 table-hover no-marg">
        ...
        if(sizeof($popular_hotels) == 0){?>
            <tr>
                <td><input id="chk_city1" type="checkbox" checked></td>
                <td><input maxlength="15" value="1" type="text" name="no" placeholder="Sr. No." class="form-control" disabled /></td>
                <td><select name="city_name-1" id="city_name-1" title="Select City" onchange="hotel_names_load(this.id)" style="width:100%" class="form-control app_select2">
                        <?php if($city_id!=''){ ?>
                        <option value="<?= $sq_city['city_id'] ?>"><?= $sq_city['city_name'] ?></option>
                        <?php } ?>
                        <?php get_cities_dropdown() ?>
        ...
        <?php
            ...
            <tr>
                <td><input id="chk_city1<?=$i?>_u" type="checkbox" checked></td>
                <td><input maxlength="15" value="<?=($i+1)?>" type="text" name="no" placeholder="Sr. No." class="form-control" disabled /></td>
                <td><select name="city_name-1<?=$i?>_u" id="city_name-1<?=$i?>_u" title="Select City" onchange="hotel_names_load(this.id)" style="width:100%" class="form-control app_select2">
                        <?php if($city_id!=''){ ?>
                        <option value="<?= $sq_city['city_id'] ?>"><?= $sq_city['city_name'] ?></option>
                        <?php } ?>
                        <?php get_cities_dropdown() ?>
    ...
    function upload_call_image(){
        ...
        new AjaxUpload(btnUpload, {
          ...
          onSubmit: function(file, ext)
          {
            ...
            error_msg_alert('Only PNG files are allowed');
            return false;
            }
