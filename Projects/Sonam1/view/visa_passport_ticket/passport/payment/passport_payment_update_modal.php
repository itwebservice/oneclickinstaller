  ...
  submitHandler:function(form){
    ...
    var base_url = $('#base_url').val();
      ...
      $.ajax({
        ...
        data:{ payment_id : payment_id, passport_id : passport_id, payment_date : payment_date, payment_amount : payment_amount, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id,payment_old_value : payment_old_value },
