		...
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
	                ...
	                $content_arr = array( number_format($visa_amount,2) ,number_format($service_charge,2), number_format($subtotal_amount,2), number_format($sq_visa_info['visa_total_cost'],2));
