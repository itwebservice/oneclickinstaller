...
$footer_data = array();
	...
	while($row_ticket = mysql_fetch_assoc($sq_ticket)){
		...
		$temp_arr = array( "data" => array(
			...
			$row_ticket['ticket_total_cost'],
			$cancel_amt,
			number_format(($row_ticket['ticket_total_cost'] - $cancel_amt), 2),
			'
			<a style="display:inline-block" href="'.$pass_url .'" target="_blank" class="btn btn-danger btn-sm" title="Download E_Ticket"><i class="fa fa-file-pdf-o"></i></a>
