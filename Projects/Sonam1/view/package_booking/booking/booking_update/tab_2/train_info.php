...
<div class="row mg_bt_30"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    ?>
        <tr>
            ...
            <td style="width: 30px;"><input type="text" id="<?php echo 'txt_train_total_seat'.$count_t.'t' ?>" name="<?php echo 'txt_train_total_seat'.$count_t.'t' ?>" placeholder="Total Seats" title="Total Seats" maxlength="2" onchange="validate_balance(this.id);" onkeyup="calculate_service_charge_seat(this.id);" value="<?php echo $row_train_details['seats'] ?>"/></td>

            <td style="width: 130px;"><input type="text" id="<?php echo 'txt_train_amount'.$count_t.'t' ?>" name="<?php echo 'txt_train_amount'.$count_t.'t' ?>" placeholder="Amount"  title="Amount" onchange="validate_balance(this.id);" onkeyup=" calculate_train_expense('tbl_train_travel_details_dynamic_row');" value="<?php echo $row_train_details['amount'] ?>" /></td>
