...
$pdf->Row(array('Vehicle Name','From-Date','To-Date'));

$q_transport = mysql_fetch_assoc(mysql_query("select * from transport_agency_bus_master where bus_id='$package_booking_info[transport_bus_id]'"));
$pdf->SetX(27);
$pdf->SetFont('Arial','',9);
$pdf->Row(array($q_transport['bus_name'],get_date_user($package_booking_info['transport_from_date']),get_date_user($package_booking_info['transport_to_date'])));
