<form id="frm_tab11_c">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
		  <select name="travel_type" id="travel_type" title="Tour Type" onchange="reflect_feilds1();get_car_cost();">
	...
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	      <input type="text" id="total_hr" name="total_hr"  placeholder="Total Hrs" title="Total Hrs" value="<?= $sq_quotation['total_hrs'] ?>" onchange=";validate_balance(this.id)">
	    </div>

		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	      <input type="text" id="total_km" name="total_km"  placeholder="Total Km" title="Total Km" value="<?= $sq_quotation['total_km'] ?>" onchange=";validate_balance(this.id)">
	    </div>
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	...
	<div class="row">
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	     <input type="text" id="days_of_traveling" name="days_of_traveling" onchange="validate_balance(this.id);" placeholder="Days Of Travelling" title="Days Of Travelling" value="<?= $sq_quotation['days_of_traveling']?>">
	    </div>
	    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
