...
<form id="frm_tab1">
	...
	<div class="row">
	    ...
	    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	     ...
	     <input type="text" id="from_date" name="from_date" placeholder="From Date" value="<?php echo $sq_enq['travel_from_date'];?>" title="From Date" onchange="get_to_date(this.id,'to_date');total_days_reflect();change_dates_ever(this.id);">
