...
$('#frm_tax_rules_save').validate({
  ...
  submitHandler:function(form){
      ...
      $.ajax({
        ...
        data:{ entry_id : entry_id, name : name, validity : validity, from_date : from_date, to_date : to_date, ledger : ledger, travel_type : travel_type, calc_mode : calc_mode, target_amount : target_amount, cond_arr : cond_arr},
