      ...
      <div class="modal-body">
        <form id="frm_tax_rules_update">
          ...
          <div class="row mg_bt_10"> 
              ...
              <div class="col-md-3">
                  <input type="text" placeholder="To Date" title="To Date" id="to_date"  class="form-control"  value="<?= get_date_user($sq_rules['to_date']) ?>"/>
              </div>
          </div>
          <div class="row"> 
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                  <select name="calc_mode" id="calc_mode" data-toggle="tooltip" class="form-control" title="Calculation Mode" required>
          ...
          <div class="row"> <div class="col-md-12"> <div class="table-responsive">
            ...
            ?>
                <tr>
                    ...
                    <td style="width:10%"><input type="text" title="Currency" id="currencyu<?= $i ?>" value="<?= ($conditions[$i]->currency != '') ? $conditions[$i]->currency : 'NA' ?>" class="form-control" disabled/></td>
                    <td style="width:20%"><input type="number" placeholder="Amount" value="<?= ($conditions[$i]->amount != ' ') ? $conditions[$i]->amount : 'NA' ?>" title="Amount" id="amountu<?= $i ?>" class="form-control" <?= $status1 ?>/></td>
          ...
          <div class="row mg_tp_20">
            <div class="col-md-12 text-center">
              <button class="btn btn-sm btn-success" id="btn_taxrules_update"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Save</button>
            </div>
          </div>
        </form>
      </div>      
...
$('#frm_tax_rules_update').validate({
  ...
  submitHandler:function(form){
      ...
      $.ajax({
        ...
        data:{ rule_id : rule_id, name : name, validity : validity, from_date : from_date, to_date : to_date, ledger : ledger, travel_type : travel_type, calc_mode : calc_mode, target_amount : target_amount, cond_arr : cond_arr,status:status},
