        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 col-sm-12 text-right">
              <button id="quot_button" title="Generate Quotation PDF" data-toggle="tooltip" class="loadBtn pdf-button-link" value="Payment" onclick="generate_pdf(<?= sizeof($activity_list_arr)?>);">Generate Quotation PDF</button>
            </div>
          ...
          <div class="row">
              ...
              <?php if(sizeof($hotel_list_arr)>0){ ?>
                <!-- ***** Hotel Listing ***** -->
                  <div class="c-cartContainer m20-btm">
                    <div class="cartHeading">Hotel Details<span class="float-right"><button id="quot_button" title="Check Availability" data-toggle="tooltip" class="c-button" style="top: -5px; position: relative;" value="Payment" onclick="check_availability();">Check Availability</button></span></div>
                    <div class="cartBody">
                      <?php
                      $price_total = 0;
                      $tax_total = 0;
                  ...
                  <div class="c-cartContainer m20-btm">
                    ...
                    <div class="cartBody">
                      ...
                      for($i=0;$i<sizeof($activity_list_arr);$i++){
                        // var_dump($activity_list_arr[$i]['service']['service_arr']);
            ...
            <div class="col-md-4 col-sm-12">
              <div class="c-cartContainer cartPricing">
                ...
                <button type='submit' onclick="proceed_to_checkout('<?= sizeof($activity_list_arr) ?>');" class="btnCheckout">Proceed to Checkout</button>
              </div>
            </div>
            <!-- ***** Listing Filter End ***** -->
          </div>
