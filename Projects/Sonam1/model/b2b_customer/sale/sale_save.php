...
class b2b_sale{
    ...
    function success_save(){
        ...
        if($sq_save){
            ...
            // ///////////////////////////////////////////////////////////////////////////////////////
            //Finance save
            $this->finance_save($booking_id,$total_hotel_cost, $total_tax,$total_cost,$tax_arr[0],$used_at,'Online',$payment_amount,$customer_id,$bank_id);
    ...
    function credit_sale_save(){
        ...
        if($sq_save){
            ...
            // ///////////////////////////////////////////////////////////////////////////////////////
            //Finance save
            $this->finance_save($booking_id,$total_hotel_cost, $total_tax,$total_cost,$tax_arr[0],$used_at,'Cash','0',$customer_id);
            //Acnowledgement mail
            $sq_cust = mysql_fetch_assoc(mysql_query("select email_id,company_name from customer_master where customer_id='$customer_id'"));
            $this->send_ack_agent_mail($sq_cust['company_name'], $sq_cust['email_id'],$cart_checkout_data);
    ...
    public function finance_save($booking_id,$total_hotel_cost,$total_tax,$total_cost,$taxation_type,$used_at,$payment_mode,$payment_amount1,$customer_id,$bank_id1)
    {
        $row_spec = 'sales';
        $branch_admin_id = 1;
        $booking_date = date("Y-m-d", strtotime($used_at));
        $year1 = explode("-", $booking_date);
        $yr1 =$year1[0];

        // $B2B_sale_amount = $B2B_issue_amount + $service_charge;
        $balance_amount = $total_cost - $payment_amount1;
        ...
        /////////Tax Amount/////////
        tax_reflection_update('B2B Booking',$total_tax,$taxation_type,$booking_id,get_b2b_booking_id($booking_id,$yr1),$booking_date, $customer_id, $row_spec,$branch_admin_id);
        ...
        $payment_date = $booking_date;
        $payment_particular = get_sales_particular(get_b2b_booking_id($booking_id,$yr1), $booking_date, $payment_amount1, $customer_id);
        ...
        $payment_date = $booking_date;
        $payment_particular = get_sales_particular(get_b2b_booking_id($booking_id,$yr1), $booking_date, $balance_amount, $customer_id);
        $ledger_particular = get_ledger_particular('To','B2B Sales');
        $gl_id = $cust_gl;
        $payment_side = "Debit";
        $clearance_status = "";
    ...
    public function bank_cash_book_save($booking_id,$used_at,$payment_mode,$payment_amount,$customer_id,$payment_id,$bank_id)
    {
        ...
        $bank_id = $bank_id;
        $particular = get_sales_paid_particular($payment_id, $payment_date, $payment_amount, $customer_id, $payment_mode, get_b2b_booking_id($booking_id,$yr1));
        $clearance_status = ($payment_mode=="Cheque") ? "Pending" : "";
        $payment_side = "Debit";
