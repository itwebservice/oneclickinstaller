...
<div class="panel panel-default panel-body app_panel_style feildset-panel" style="margin-bottom: 30px;">
	...
	<div class="main_block mg_tp_20">
		...
		<div class="col-md-2 text-right"><label for="app_website">Children Without Bed</label></div>
		<div class="col-md-2 no-pad">
			<input type="text" id="cwb" class="form-control" name="cwb" placeholder="Children Without Bed" title="Children Without Bed">   
		</div>
	</div>
	<div class="main_block mg_tp_20">
		<div class="col-md-2 text-right"><label for="app_website">Children With Bed</label></div>
		<div class="col-md-2 no-pad">
			<input type="text" id="cb" class="form-control" name="cb" placeholder="Children With Bed" title="Children With Bed">   
		</div>
    ...
    submitHandler:function(form){
	   ...
	   //Creating enquiry content
		enquiry_content = [
			...
			{name : "total_children", "value" : total_children},
			{name : "total_infant", "value" : total_infant},
			{name : "total_members", "value" : parseInt(total_children)+parseInt(total_adult)+parseInt(total_infant)},
