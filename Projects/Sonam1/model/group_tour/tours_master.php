...

{
  ...
  for($i=0; $i<sizeof($plane_from_location_arr); $i++){
    ...
    $sq_plane = mysql_query("insert into group_tour_plane_entries ( id, tour_id, from_city, from_location, to_city,to_location,airline_name, class) values ( '$id', '$max_tour_id', '$from_city_id_arr[$i]', '$plane_from_location_arr[$i]', '$to_city_id_arr[$i]', '$plane_to_location_arr[$i]','$airline_name_arr[$i]', '$plane_class_arr[$i]' )");
...

{
  ...
  for($i=0; $i<sizeof($plane_from_location_arr); $i++){
...

      {
        ...
        $sq_plane = mysql_query("insert into group_tour_plane_entries ( id, tour_id,from_city, to_city, from_location, to_location,airline_name, class) values ( '$id', '$tour_id', '$from_city_id_arr[$i]', '$to_city_id_arr[$i]', '$plane_from_location_arr[$i]', '$plane_to_location_arr[$i]','$airline_name_arr[$i]', '$plane_class_arr[$i]' )");
...

      {
        ...
        $sq_update=mysql_query("UPDATE `group_tour_plane_entries` SET  `from_location`='$plane_from_location_arr[$i]',`to_location`='$plane_to_location_arr[$i]',airline_name='$airline_name_arr[$i]',`class`='$plane_class_arr[$i]',from_city='$from_city_id_arr[$i]', to_city='$to_city_id_arr[$i]' WHERE `id`='$plane_id_arr[$i]'");
