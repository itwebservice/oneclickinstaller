...
//////////////////////////**Booking successfull sms send to traveler start**////////////////
 function booking_successfull_sms_send($m_mobile_no,$customer_id,$tour_id){
  ...
  $message = "Dear ".$sq_customer['first_name']." ".$sq_customer['last_name'].", your booking for ".$tour_name." has been confirmed. Voucher details send on your Mail ID within 3 working days prior to the tour." ;
