...
//////////////////////////////////**Payment notification message send start**/////////////////////////////////////
 function payment_notification_sms_send($payment_amount, $payment_mode, $tourwise_traveler_id)
 {
   global $currency;
    ...
    $message = "Dear customer, Acknowledge your payment of ".$payment_amount." ".$currency_code."  which we received for Group Tour installment. (T&C) Check the currency from the Company Profile Section.";
    global $model;
