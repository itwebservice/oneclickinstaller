...

{
	...
	$content1 .= '
	<tr>
      <td style="text-align:left;border: 1px solid #888888;">'.($i+1).'</td>   <td style="text-align:left;border: 1px solid #888888;">'.$sq_exc['service_name'].'</td>   
    </tr>
    ...
    <tr>
      ...
      <th style="border: 1px solid #888888;text-align: left;background: #ddd;color: #888888;">Excursion Name
      </th>
    </tr>
	...
	$model->app_email_send('42',$sq_customer['first_name'],$sq_customer['email_id'], $content,$subject);
