      ...
      <div class="modal-body profile_box_padding">
      	...
      	<div>
			  ...
			  <ul class="nav nav-tabs responsive" role="tablist">
			    ...
			    <!-- <li role="presentation"><a href="#hotel_images" aria-controls="profile" role="tab" data-toggle="tab" class="tab_name">Hotel Gallery</a></li>

			    <li role="presentation"><a href="#gallary" aria-controls="profile" role="tab" data-toggle="tab" class="tab_name">Sightseeing Gallery</a></li> -->
			    ...
			    <li role="presentation" class="pull-right"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></li>
				  ...
				  <div class="tab-content responsive">
				    ...
				    <!-- <div role="tabpanel" class="tab-pane no-pad-sm" id="gallary">
				     <div class="panel panel-default panel-body fieldset profile_background no-pad-sm">
