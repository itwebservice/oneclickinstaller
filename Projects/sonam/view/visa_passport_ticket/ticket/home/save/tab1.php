<form id="frm_tab1">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
			...
			<select name="customer_id" id="customer_id" class="customer_dropdown" title="Select Customer Name" style="width:100%" onchange="customer_info_load()">
	...
	submitHandler:function(form){
...

        {
          ...
          if(row.cells[0].childNodes[0].checked)
          {
			  ...
			  if(adolescence=="Children"){ childrens = childrens+1; }
