        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
         <legend>Quotation Details</legend>
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10" >
               <input type="text" id="capacity" name="capacity" onchange="validate_balance(this.id);calculate_total_fees()" placeholder="Capacity" title="Capacity" class="form-control">
            </div>
           
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="total_pax" name="total_pax" onchange="validate_balance(this.id);calculate_total_fees();" placeholder="No Of Pax" title="No Of Pax" class="form-control">
            </div>  
            
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <textarea type="text" name="local_places_to_visit" class="form-control" id="local_places_to_visit" onchange="validate_spaces(this.id);calculate_total_fees()" placeholder="Route" title="Route" rows="1"></textarea>
          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="from_date" name="from_date" placeholder="From Date" title="From Date" value="<?= date('d-m-Y')?>" class="form-control" onchange="total_days_reflect();;calculate_total_fees()">
            </div> 
          
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="to_date" name="to_date" placeholder="To Date" title="To Date" value="<?= date('d-m-Y')?>" class="form-control" onchange="total_days_reflect();calculate_total_fees()">
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="days_of_traveling" onchange="validate_balance(this.id);calculate_total_fees();" name="days_of_traveling" class="form-control" placeholder="Days Of Travelling" title="Days Of Travelling">
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <input type="text" id="rate" class="text-right form-control" name="rate" placeholder="Rate" title="Rate" onchange="calculate_total_fees();" >
              </div>
           
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                  <input type="text" id="extra_km" name="extra_km" class="text-right form-control" placeholder="Extra Km Rate" title="Extra KM Rate" onchange="calculate_total_fees();validate_balance(this.id)">
                </div>               
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="extra_hr_cost" name="extra_hr_cost" class="text-right form-control" placeholder="Extra Hr Rate" title="Extra Hr Rate" onchange="calculate_total_fees();validate_balance(this.id);">
            </div> 
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="traveling_date" name="traveling_date" placeholder="Travelling Date" title="Travelling Date" onchange="calculate_total_fees();">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <legend>Costing Details</legend>
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <input type="text" id="permit_charges" name="permit_charges" class="text-right form-control" placeholder="Permit Charges" title="Permit Charges" onchange="calculate_total_fees();validate_balance(this.id)">
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <input type="text" id="toll_and_parking" name="toll_and_parking" class="text-right form-control" placeholder="Toll & Parking" title="Toll & Parking" onchange="calculate_total_fees();validate_balance(this.id)">
                </div>            
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <input type="text" id="state_entry_tax" name="state_entry_tax" class="text-right form-control" placeholder="State Entry Tax" title="State Entry Tax" onchange="calculate_total_fees();validate_balance(this.id)">
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <input type="text" id="other_charges" name="other_charges" class="text-right form-control" placeholder="Other Charges" title="Other Charges" onchange="calculate_total_fees();validate_balance(this.id)">
                </div>
              </div>
              <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <input type="text" id="basic_amount" name="basic_amount" class="text-right form-control" placeholder="Basic Amount" title="Basic Amount" onchange="calculate_total_fees();validate_balance(this.id)">
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                    <input type="text" id="markup_cost" name="markup_cost" class="text-right form-control" placeholder="Markup Cost(%)" title="Markup Cost(%)" onchange="calculate_total_fees();validate_balance(this.id)" value="0.00">
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                    <input type="text" id="markup_cost_subtotal" name="markup_cost_subtotal" placeholder="Markup Cost Subtotal" title="Markup Cost Subtotal" class="text-right form-control" onchange="calculate_total_fees();" value="0.00">  
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <select name="taxation_type" id="taxation_type" title="*Tax Name" class="text-right form-control">
                    <?php get_taxation_type_dropdown($setup_country_id) ?>
                  </select>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <select name="taxation_id" id="taxation_id" title="Tax" onchange="generic_tax_reflect(this.id, 'service_tax', 'calculate_total_fees');" class="text-right form-control">
                      <?php get_taxation_dropdown(); ?>
                  </select>
                  <input type="hidden" id="service_tax" name="service_tax" value="0" class="text-right form-control">
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
              ...
              if(data !== 'valid'){
                ...
                if(data !== 'valid'){
                  ...
                  return false;
                    ...
                    // whatsapp_send(emp_id, customer_id, booking_date, base_url);
                    ...
                    $.ajax({
                      ...
                      data:{ emp_id : emp_id, customer_id : customer_id,quotation_id : quotation_id, total_pax : total_pax,pass_name : pass_name, days_of_traveling : days_of_traveling,  travel_type : travel_type, places_to_visit : places_to_visit, extra_km : extra_km,taxation_type : taxation_type, taxation_id : taxation_id, service_tax : service_tax, service_tax_subtotal : service_tax_subtotal, total_cost : total_cost, driver_allowance : driver_allowance, permit_charges : permit_charges, toll_and_parking : toll_and_parking, state_entry_tax : state_entry_tax, total_fees : total_fees, payment_amount : payment_amount, payment_date : payment_date, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id , due_date : due_date,booking_date : booking_date, branch_admin_id : branch_admin_id,capacity:capacity,places_to_visit:places_to_visit,from_date:from_date,to_date:to_date,total_hrs:total_hrs,total_km:total_km,rate:rate,total_max_km:total_max_km,extra_hr_cost:extra_hr_cost,state_entry_tax:state_entry_tax,other_charges:other_charges,basic_amount:basic_amount,markup_cost:markup_cost,markup_cost_subtotal:markup_cost_subtotal,vehicle_name:vehicle_name,local_places_to_visit:local_places_to_visit,traveling_date:traveling_date},
                      success:function(result){
                        console.log(result);
                        $('#btn_booking_save').button('reset');
