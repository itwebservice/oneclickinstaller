      ...
      <div class="modal-body">
        <form id="frm_other_rules_update">
          ...
          <div class="row mg_tp_10"> 
              ...
              <div class="col-md-3">
                  <input type="text" placeholder="*Amount" title="Amount" id="amounts" value="<?= $sq_rules['fee'] ?>" class="form-control" required />
              </div>
          </div>
          <div class="row mg_tp_10">
              <div class="col-md-3">
...
$('#frm_other_rules_update').validate({
  ...
  submitHandler:function(form){
      ...
      $.ajax({
        ...
        data:{ rule_id:rule_id,rule_for : rule_for, name : name,type:type, validity : validity, from_date : from_date, to_date : to_date, ledger : ledger,amount:amount1,amount_in:amount_in, travel_type : travel_type, target_amount : target_amount, cond_arr : cond_arr,status:status},
