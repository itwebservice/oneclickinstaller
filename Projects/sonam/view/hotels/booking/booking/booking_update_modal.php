    ...
    <div class="modal-content">
      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
          ...
          <div class="row mg_tp_20">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="markup1" name="markup1" placeholder="Markup " title="Markup" onchange="total_fun1();validate_balance(this.id)" value="<?= $sq_booking['markup'] ?>">
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
...
function total_fun1()
{
  ...
  var total_amount = parseFloat(sub_total) + parseFloat(service_tax_subtotal) + parseFloat(service_charge) + parseFloat(markup) - parseFloat(tds) - parseFloat(discount);
    ...
    submitHandler:function(form){
        ...
        var base_url = $('#base_url').val();
            ...
            $.ajax({
              ...
              data:{ booking_id : booking_id, customer_id : customer_id,pass_name : pass_name, adults : adults, childrens : childrens, infants : infants, sub_total : sub_total, service_charge : service_charge, taxation_type : taxation_type, taxation_id : taxation_id, service_tax : service_tax, service_tax_subtotal : service_tax_subtotal,markup:markup, discount : discount, tds : tds, total_fee : total_fee, city_id_arr : city_id_arr, hotel_id_arr : hotel_id_arr, check_in_arr : check_in_arr, check_out_arr : check_out_arr, no_of_nights_arr : no_of_nights_arr, rooms_arr : rooms_arr, room_type_arr : room_type_arr, category_arr : category_arr, accomodation_type_arr : accomodation_type_arr, extra_beds_arr : extra_beds_arr, meal_plan_arr : meal_plan_arr, conf_no_arr : conf_no_arr, entry_id_arr : entry_id_arr, due_date1 : due_date1, booking_date1 : booking_date1 },
