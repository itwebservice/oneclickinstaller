      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="markup" name="markup" placeholder="Markup " title="Markup" onchange="total_fun();validate_balance(this.id)">
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
        ...
        for(var i=0; i<rowCount; i++)
        {
          ...
          if(row.cells[0].childNodes[0].checked)
          {
              ...
              $.ajax({
                ...
                data:{ emp_id : emp_id,unique_timestamp : unique_timestamp, customer_id : customer_id,pass_name : pass_name, adults : adults, childrens : childrens, infants : infants, sub_total : sub_total, service_charge : service_charge, taxation_type : taxation_type, taxation_id : taxation_id, service_tax : service_tax, service_tax_subtotal : service_tax_subtotal,markup:markup, discount : discount, tds : tds, total_fee : total_fee, payment_date : payment_date, payment_amount : payment_amount, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id, city_id_arr : city_id_arr, hotel_id_arr : hotel_id_arr, check_in_arr : check_in_arr, check_out_arr : check_out_arr, no_of_nights_arr : no_of_nights_arr, rooms_arr : rooms_arr, room_type_arr : room_type_arr, category_arr : category_arr, accomodation_type_arr : accomodation_type_arr, extra_beds_arr : extra_beds_arr, meal_plan_arr : meal_plan_arr, conf_no_arr : conf_no_arr, due_date : due_date, booking_date : booking_date , branch_admin_id : branch_admin_id },
                success: function(result){
