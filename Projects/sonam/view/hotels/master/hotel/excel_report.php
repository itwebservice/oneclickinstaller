...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('X'.$row_count, "Child Without Bed From-To Age")
        ->setCellValue('Y'.$row_count, "Child With Bed From-To Age")
...
while($row_hotel = mysql_fetch_assoc($sq_hotel)){
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('X'.$row_count, $row_hotel['cwob_from'].'-'.$row_hotel['cwob_to'])
        ->setCellValue('Y'.$row_count, $row_hotel['cwb_from'].'-'.$row_hotel['cwb_to'])
