<form id="frm_tab1">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	      ...
	      <input type="text" class="form-control" id="customer_name" onchange="fname_validate(this.id);" name="customer_name"  placeholder="Customer Name" title="Customer Name"> 
	...
	<div class="row text-center mg_tp_20">
		...
		<div class="col-xs-12">
			...
			<button id="handler" class="btn btn-info btn-sm ico_right">Next&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>
