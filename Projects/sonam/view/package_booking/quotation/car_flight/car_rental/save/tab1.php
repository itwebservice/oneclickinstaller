<form id="frm_tab1">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
		  <select name="travel_type" id="travel_type" title="Tour Type" onchange="get_car_cost();reflect_feilds();">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
			<input type="text" id="from_date" name="from_date" placeholder="Travel From Date" title="Travel From Date" value="<?= date('d-m-Y')?>" onchange="get_to_datetime(this.id,'to_date');total_days_reflect()">
		</div>	
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	      <input type="text" id="to_date" name="to_date" placeholder="Travel To Date" title="Travel To Date" value="<?= date('d-m-Y')?>" onchange="total_days_reflect()">
	    </div>
	</div>
...
$('#from_date,#to_date,#total_hr,#total_km,#total_max_km,#driver_allowance,#permit_charges,#toll_parking,#state_entry,#other_charges,#local_places_to_visit,#places_to_visit,#traveling_date').hide();
