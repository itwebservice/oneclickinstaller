...
<div class="row mg_bt_10">
	...
	<div class="col-md-2">
  		<input type="text" id="subtotal" name="subtotal" class="text-right form-control" placeholder="Basic Cost" title="Basic Cost" onchange="quotation_cost_calculate();validate_balance(this.id)" value="0.00">  
  	</div>
	<div class="col-md-2">
  		<input type="text" id="markup_cost" name="markup_cost" class="text-right form-control" placeholder="Markup Cost(%)" title="Markup Cost(%)" onchange="quotation_cost_calculate();validate_balance(this.id)" value="0.00">  
  	</div>
	<div class="col-md-2">
  		<input type="text" id="markup_cost_subtotal" name="markup_cost_subtotal" class="text-right form-control" placeholder="Markup Cost Subtotal" title="Markup Cost Subtotal" onchange="quotation_cost_calculate();" value="0.00">  
  	</div>
  	<div class="col-md-2">
  		<select name="taxation_id" id="taxation_id" title="Tax" class="text-right form-control" onchange="quotation_cost_calculate();generic_tax_reflect(this.id, 'service_tax', 'quotation_cost_calculate');">
	...
	<div class="col-md-2">
		<input type="text" id="service_tax_subtotal" name="service_tax_subtotal" class="text-right form-control" readonly placeholder="Tax Amount" title="Tax Amount">
	</div>
...
<div class="row mg_bt_10">
	...
	<div class="col-md-2">
		<input type="text"  id="other_charges"  name="other_charges" class="text-right form-control" placeholder="Other Cahrges" title="Other Cahrges" onchange="quotation_cost_calculate();validate_balance(this.id)" value="0.00"> 
	</div>
