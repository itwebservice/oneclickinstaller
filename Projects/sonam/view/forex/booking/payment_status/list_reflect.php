...
$query .= " order by booking_id desc";	
		...
		while($row_booking = mysql_fetch_assoc($sq_booking)){
			...
			$temp_arr = array( "data" => array(
				...
				'<button class="btn btn-info btn-sm" onclick="forex_view_modal('. $row_booking['passport_id'] .')" data-toggle="tooltip" title="View Detail"><i class="fa fa-eye" aria-hidden="true"></i></button>',
				...
				number_format($row_booking['service_tax_subtotal'],2),
				number_format($total_sale,2),
				number_format($paid_amount, 2),
				'<button class="btn btn-info btn-sm" onclick="payment_view_modal('.$row_booking['passport_id'] .')"  data-toggle="tooltip" title="View Detail"><i class="fa fa-eye" aria-hidden="true"></i></button>',
				number_format($bal, 2),
				number_format($total_purchase,2),
				'<button class="btn btn-info btn-sm" onclick="supplier_view_modal('. $row_booking['passport_id'] .')" data-toggle="tooltip" title="View Detail"><i class="fa fa-eye" aria-hidden="true"></i></button>',
				$branch_name,
				$emp_name,
