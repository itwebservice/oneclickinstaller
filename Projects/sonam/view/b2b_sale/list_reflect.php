...
while($row_customer = mysql_fetch_assoc($sq_customer)){
	...
	$temp_arr = array( "data" => array(
		...
		<button data-toggle="tooltip" class="btn btn-info btn-sm" style="display:inline-block" onclick="customer_display_modal('. $row_customer['booking_id'] .')" title="View Details"><i class="fa fa-eye"></i></button><a data-toggle="tooltip" onclick="loadOtherPage(\''. $service_url .'\')" class="btn btn-info btn-sm" title="Generate Service Voucher"><i class="fa fa-print"></i></a>'
		), "bg" =>$bg );
