        ...
        <div class="panel panel-default panel-body app_panel_style">
            <div class="row text-center">   
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs"> 
                    ...
                    <input type="text" id="txt_child_with_cost" name="txt_child_with_cost" onchange="validate_balance(this.id)" class="form-control"  placeholder="*Child With Bed Cost" title="Child With Bed Cost" maxlength="10" />

                </div>
                <div class="col-md-3 col-sm-6 mg_bt_10_xs"> 

                    <input type="text" id="txt_child_without_cost" name="txt_child_without_cost" onchange="validate_balance(this.id)" class="form-control"  placeholder="Child Without Bed Cost" title="Child Without Bed Cost" maxlength="10" />
