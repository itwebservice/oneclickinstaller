...
$values_query = "select * from $table_name where $customer_field = $inside_customer_id";
...
<section class="print_sec_bt_s main_block">
  ...
  <div class="border_block inv_rece_back_detail">
    <div class="row">
      <div class="col-md-4"><p class="border_lt"><span class="font_5">RECEIPT AMOUNT : </span><?php echo $currency_logo." ".$payment_amount; ?></p></div>
