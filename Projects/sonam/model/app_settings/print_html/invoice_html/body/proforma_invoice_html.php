    ...
    <div class="col-md-4 last_h_sep_border_lt">
      <div class="inv_rece_header_right text-right">
        <ul class="no-pad no-marg font_s_12">
          ...
          <li><p><?php echo $app_address; ?></p></li>
          <li><i class="fa fa-phone" style="margin-right: 5px;"></i> <?php echo $app_contact_no; ?></li>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="main_block inv_rece_calculation border_block">
        <div class="col-md-12"><p class="border_lt"><span class="font_5">AMOUNT </span><span class="float_r"><?= $currency_logo." ".$basic_cost1 ?></span></p></div>
        <div class="col-md-12"><p class="border_lt"><span class="font_5">TAX</span><span class="float_r"><?= $currency_logo." ".$service_tax1 ?></span></p></div>
        <?php if($for == 'Package Tour'){ ?>
        <div class="col-md-12"><p class="border_lt"><span class="font_5">Travel+Visa+Guide+Misc </span><span class="font_5 float_r"><?= $currency_logo." ".$travel_cost1 ?></span></p></div>
        <?php } ?>
        <div class="col-md-12"><p class="border_lt"><span class="font_5">TOTAL </span><span class="font_5 float_r"><?= $currency_logo." ".number_format($net_amount,2) ?></span></p></div>
      </div>
    </div>
  </div>
