           ...
           <div class="table-responsive">
            <table class="table no-marg mg_tp_5 gst_invoice" style="padding: 0 !important;">
              ...
              <tr>
                ...
                <td class="text-right col-md-4"><?php if($taxation_type=="SGST CGST"){echo $currency_logo." ".$cgst_sgst; } ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="text-right col-md-4"> <?php if($taxation_type=="IGST"){echo $currency_logo." ".$service_tax_subtotal; } ?></td>
              </tr>
              <tr>
                <td class="text-right col-md-8">Add : UGST <?php if($taxation_type=="UGST"){ ?>@<?= $service_tax_per ?>%            <?php } ?>:</td>
                <td class="text-right col-md-4"> <?php if($taxation_type=="UGST"){echo $currency_logo." ".$service_tax_subtotal; } ?></td>
              </tr>
              <tr>
                <td class="text-right col-md-8">Tax Amount : GST @<?= $service_tax_per ?>% :</td>
                <td class="text-right col-md-4"><?= $currency_logo." ".$service_tax_subtotal ?></td>
              </tr>
              <tr class="hightlited_row">
                <td class="text-right col-md-8">Total Amount After Tax :</td>
                <td class="text-right col-md-4"><?= $currency_logo." ".number_format($net_amount,2) ?></td>
              </tr>
            </table>
           </div>
         </div>
