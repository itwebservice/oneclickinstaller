...

{
	...
	$sq_login = mysql_query("insert into hotel_vendor_price_master (pricing_id, city_id,hotel_id, currency_id , created_at) values ('$pricing_id','$city_id','$hotel_id','$currency_code', '$created_at')");
...

{
	...
	$sq_login = mysql_query("update hotel_vendor_price_master set  currency_id = '$currency_code' where pricing_id = '$sq_query[pricing_id]'");
