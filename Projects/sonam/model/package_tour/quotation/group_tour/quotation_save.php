...
public function quotation_master_save()
{
	...
	$sq_quotation = mysql_query("insert into group_tour_quotation_master ( quotation_id, branch_admin_id,financial_year_id, tour_name, from_date, to_date, total_days, customer_name, email_id, total_adult, total_children, total_infant, total_passangers, children_without_bed, children_with_bed, quotation_date, booking_type,  adult_cost, children_cost , infant_cost, with_bed_cost, tour_cost, markup_cost,markup_cost_subtotal, service_tax, taxation_id, service_tax_subtotal, quotation_cost, incl, excl, terms, tour_group_id, created_at, login_id, enquiry_id, tour_group,emp_id ) values ( '$quotation_id', '$branch_admin_id','$financial_year_id', '$tour_name', '$from_date', '$to_date', '$total_days', '$customer_name', '$email_id', '$total_adult', '$total_children', '$total_infant', '$total_passangers', '$children_without_bed', '$children_with_bed', '$quotation_date', '$booking_type', '$adult_cost','$children_cost','$infant_cost','$with_bed_cost','$tour_cost', '$markup_cost','$markup_cost_subtotal', '$service_tax', '$taxation_id', '$service_tax_subtotal', '$total_tour_cost','$incl','$excl','$terms', '$tour_group_id', '$created_at', '$login_id', '$enquiry_id', '$tour_group','$emp_id' )");
